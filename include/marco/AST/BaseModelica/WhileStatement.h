#ifndef MARCO_AST_BASEMODELICA_WHILESTATEMENT_H
#define MARCO_AST_BASEMODELICA_WHILESTATEMENT_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Statement_While;
  }
...
#endif // MARCO_AST_BASEMODELICA_WHILESTATEMENT_H
