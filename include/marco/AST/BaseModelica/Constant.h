#ifndef MARCO_AST_BASEMODELICA_CONSTANT_H
#define MARCO_AST_BASEMODELICA_CONSTANT_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Expression_Constant;
  }
...
#endif // MARCO_AST_BASEMODELICA_CONSTANT_H
