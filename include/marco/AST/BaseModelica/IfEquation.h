#ifndef MARCO_AST_BASEMODELICA_IFEQUATION_H
#define MARCO_AST_BASEMODELICA_IFEQUATION_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Equation_If;
  }
...
#endif // MARCO_AST_BASEMODELICA_IFEQUATION_H
