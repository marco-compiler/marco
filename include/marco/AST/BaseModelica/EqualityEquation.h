#ifndef MARCO_AST_BASEMODELICA_EQUALITYEQUATION_H
#define MARCO_AST_BASEMODELICA_EQUALITYEQUATION_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Equation_Equality;
  }
...
#endif // MARCO_AST_BASEMODELICA_EQUALITYEQUATION_H
