#ifndef MARCO_AST_BASEMODELICA_REDUCTIONFUNCTIONCALLARGUMENT_H
#define MARCO_AST_BASEMODELICA_REDUCTIONFUNCTIONCALLARGUMENT_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() ==
           ASTNodeKind::FunctionArgument_Reduction;
  }
...
#endif // MARCO_AST_BASEMODELICA_REDUCTIONFUNCTIONCALLARGUMENT_H
