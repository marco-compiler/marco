#ifndef MARCO_AST_BASEMODELICA_EXTERNALFUNCTIONCALL_H
#define MARCO_AST_BASEMODELICA_EXTERNALFUNCTIONCALL_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::ExternalFunctionCall;
  }
...
#endif // MARCO_AST_BASEMODELICA_EXTERNALFUNCTIONCALL_H
