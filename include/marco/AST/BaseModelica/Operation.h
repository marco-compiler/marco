#ifndef MARCO_AST_BASEMODELICA_OPERATION_H
#define MARCO_AST_BASEMODELICA_OPERATION_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Expression_Operation;
  }
...
#endif // MARCO_AST_BASEMODELICA_OPERATION_H
