#ifndef MARCO_AST_BASEMODELICA_MEMBER_H
#define MARCO_AST_BASEMODELICA_MEMBER_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Member;
  }
...
#endif // MARCO_AST_BASEMODELICA_MEMBER_H
