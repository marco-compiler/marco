#ifndef MARCO_AST_BASEMODELICA_RECORD_H
#define MARCO_AST_BASEMODELICA_RECORD_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Class_Record;
  }
...
#endif // MARCO_AST_BASEMODELICA_RECORD_H
