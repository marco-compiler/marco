#ifndef MARCO_AST_BASEMODELICA_COMPONENTREFERENCE_H
#define MARCO_AST_BASEMODELICA_COMPONENTREFERENCE_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() ==
           ASTNodeKind::Expression_ComponentReference;
  }
...
#endif // MARCO_AST_BASEMODELICA_COMPONENTREFERENCE_H
