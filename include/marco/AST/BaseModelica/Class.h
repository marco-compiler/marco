#ifndef MARCO_AST_BASEMODELICA_CLASS_H
#define MARCO_AST_BASEMODELICA_CLASS_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() >= ASTNodeKind::Class &&
           node->getKind<ASTNodeKind>() <= ASTNodeKind::Class_LastClass;
  }
...
#endif // MARCO_AST_BASEMODELICA_CLASS_H
