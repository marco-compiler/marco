#ifndef MARCO_AST_BASEMODELICA_TYPEPREFIX_H
#define MARCO_AST_BASEMODELICA_TYPEPREFIX_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::TypePrefix;
  }
...
#endif // MARCO_AST_BASEMODELICA_TYPEPREFIX_H
