#ifndef MARCO_AST_BASEMODELICA_ARRAYDIMENSION_H
#define MARCO_AST_BASEMODELICA_ARRAYDIMENSION_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::ArrayDimension;
  }
...
#endif // MARCO_AST_BASEMODELICA_ARRAYDIMENSION_H
