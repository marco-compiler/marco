#ifndef MARCO_AST_BASEMODELICA_FORSTATEMENT_H
#define MARCO_AST_BASEMODELICA_FORSTATEMENT_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Statement_For;
  }
...
#endif // MARCO_AST_BASEMODELICA_FORSTATEMENT_H
