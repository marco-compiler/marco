#ifndef MARCO_AST_BASEMODELICA_WHENEQUATION_H
#define MARCO_AST_BASEMODELICA_WHENEQUATION_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Equation_When;
  }
...
#endif // MARCO_AST_BASEMODELICA_WHENEQUATION_H
