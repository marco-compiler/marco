#ifndef MARCO_AST_BASEMODELICA_TUPLE_H
#define MARCO_AST_BASEMODELICA_TUPLE_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Expression_Tuple;
  }
...
#endif // MARCO_AST_BASEMODELICA_TUPLE_H
