#ifndef MARCO_AST_BASEMODELICA_SUBSCRIPT_H
#define MARCO_AST_BASEMODELICA_SUBSCRIPT_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Expression_Subscript;
  }
...
#endif // MARCO_AST_BASEMODELICA_SUBSCRIPT_H
