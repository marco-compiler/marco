#ifndef MARCO_AST_BASEMODELICA_IFSTATEMENT_H
#define MARCO_AST_BASEMODELICA_IFSTATEMENT_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Statement_If;
  }
...
#endif // MARCO_AST_BASEMODELICA_IFSTATEMENT_H
