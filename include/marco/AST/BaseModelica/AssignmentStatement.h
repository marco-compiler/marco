#ifndef MARCO_AST_BASEMODELICA_ASSIGNMENTSTATEMENT_H
#define MARCO_AST_BASEMODELICA_ASSIGNMENTSTATEMENT_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Statement_Assignment;
  }
...
#endif // MARCO_AST_BASEMODELICA_ASSIGNMENTSTATEMENT_H
