#ifndef MARCO_AST_BASEMODELICA_REDUCTION_H
#define MARCO_AST_BASEMODELICA_REDUCTION_H
...
public:
  ...
  static bool classof(const ASTNode *node) {
    return node->getKind<ASTNodeKind>() == ASTNodeKind::Expression_Reduction;
  }
...
#endif // MARCO_AST_BASEMODELICA_REDUCTION_H
