#ifndef MARCO_CODEGEN_LOWERING_BASEMODELICA_RESULTS_H
#define MARCO_CODEGEN_LOWERING_BASEMODELICA_RESULTS_H
...
#endif // MARCO_CODEGEN_LOWERING_BASEMODELICA_RESULTS_H
