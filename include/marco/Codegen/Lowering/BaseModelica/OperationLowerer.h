#ifndef MARCO_CODEGEN_LOWERING_BASEMODELICA_OPERATIONLOWERER_H
#define MARCO_CODEGEN_LOWERING_BASEMODELICA_OPERATIONLOWERER_H
...
#endif // MARCO_CODEGEN_LOWERING_BASEMODELICA_OPERATIONLOWERER_H
