#ifndef MARCO_CODEGEN_LOWERING_BASEMODELICA_WHENEQUATIONLOWERER_H
#define MARCO_CODEGEN_LOWERING_BASEMODELICA_WHENEQUATIONLOWERER_H
...
#endif // MARCO_CODEGEN_LOWERING_BASEMODELICA_WHENEQUATIONLOWERER_H
