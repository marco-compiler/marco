#ifndef MARCO_CODEGEN_LOWERING_BASEMODELICA_STANDARDFUNCTIONLOWERER_H
#define MARCO_CODEGEN_LOWERING_BASEMODELICA_STANDARDFUNCTIONLOWERER_H
...
#endif // MARCO_CODEGEN_LOWERING_BASEMODELICA_STANDARDFUNCTIONLOWERER_H
