#ifndef MARCO_CODEGEN_LOWERING_BASEMODELICA_CLASSDEPENDENCYGRAPH_H
#define MARCO_CODEGEN_LOWERING_BASEMODELICA_CLASSDEPENDENCYGRAPH_H
...
template <>
struct DenseMapInfo<
    marco::codegen::lowering::bmodelica::ClassDependencyGraph::Node> {
  static inline marco::codegen::lowering::bmodelica::ClassDependencyGraph::Node
  getEmptyKey() {
    return {nullptr, {}};
  }
  ...
  static unsigned getHashValue(
      const marco::codegen::lowering::bmodelica::ClassDependencyGraph::Node
          &val) {
    return llvm::hash_value(val.path.get());
  }

  static bool
  isEqual(const marco::codegen::lowering::bmodelica::ClassDependencyGraph::Node
              &lhs,
          const marco::codegen::lowering::bmodelica::ClassDependencyGraph::Node
              &rhs) {
...
template <>
struct GraphTraits<
    const marco::codegen::lowering::bmodelica::ClassDependencyGraph *> {
  using GraphType =
      const marco::codegen::lowering::bmodelica::ClassDependencyGraph *;
  using NodeRef =
      marco::codegen::lowering::bmodelica::ClassDependencyGraph::Node;
  ...
  using ChildIteratorType =
      std::set<marco::codegen::lowering::bmodelica::ClassDependencyGraph::
                   Node>::const_iterator;
...
#endif // MARCO_CODEGEN_LOWERING_BASEMODELICA_CLASSDEPENDENCYGRAPH_H
