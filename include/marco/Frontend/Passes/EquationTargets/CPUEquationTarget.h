#ifndef MARCO_FRONTEND_PASSES_EQUATIONTARGETS_CPUEQUATIONTARGET_H
#define MARCO_FRONTEND_PASSES_EQUATIONTARGETS_CPUEQUATIONTARGET_H

#include "marco/Frontend/Passes/EquationTargets/EquationTarget.h"

namespace marco::frontend {
class CPUEquationTarget : public EquationTarget {
public:
  CPUEquationTarget(llvm::StringRef name);
...
#endif // MARCO_FRONTEND_PASSES_EQUATIONTARGETS_CPUEQUATIONTARGET_H
