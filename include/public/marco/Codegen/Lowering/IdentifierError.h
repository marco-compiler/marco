...
namespace marco::codegen::lowering
{
  ...
  class IdentifierError
  {
    ...
    private:
      ...
      /**
       * @brief Computes the identifier with the lowest syntactic distance to actual among
       * the given ones. Returns its name and distance.
       * 
       * The method computes the edit distances between actual and all elements of 
       * possibleIdentifiers. It returns a pair, with the distance of the closest identifier
       * as the first element and said identifier as the second element
      ...
      /**
       * @brief Computes the identifier with the highest semantic similarity to actual among
       * the given ones. Returns its name and similarity.
       * 
       * The method computes the semantic similarity between actual and all elements of 
       * possibleIdentifiers. It returns a pair, with the similarity of the closest identifier
       * as the first element and said identifier as the second element
       * @ref marco::codegen::lowering::SentenceDistanceCalculator.
       */
