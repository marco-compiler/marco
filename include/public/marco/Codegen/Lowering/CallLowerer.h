...
namespace marco::codegen::lowering
{
  ...
  class CallLowerer : public Lowerer
  {
    ...
    private:
      ...
      void emitErrorNumArguments(const std::string &function, unsigned int line, unsigned int column, 
                                 unsigned int actualNum, unsigned int expectedNum);
      void emitErrorNumArgumentsRange(const std::string &function, unsigned int line, unsigned int column,
