#ifndef MARCO_DIALECT_BASEMODELICA_IR_VARIABLESDEPENDENCYGRAPH_H
#define MARCO_DIALECT_BASEMODELICA_IR_VARIABLESDEPENDENCYGRAPH_H
...
public:
  ...
  [[nodiscard]] std::set<Node>::const_iterator childrenBegin(Node node) const;

  [[nodiscard]] std::set<Node>::const_iterator childrenEnd(Node node) const;
...
struct DenseMapInfo<::mlir::bmodelica::VariablesDependencyGraph::Node> {
  ...
  static unsigned
  getHashValue(const ::mlir::bmodelica::VariablesDependencyGraph::Node &val) {
    return std::hash<mlir::Operation *>{}(val.variable);
  }

  static bool
  isEqual(const ::mlir::bmodelica::VariablesDependencyGraph::Node &lhs,
...
struct GraphTraits<const ::mlir::bmodelica::VariablesDependencyGraph *> {
  ...
  using ChildIteratorType = std::set<
      ::mlir::bmodelica::VariablesDependencyGraph::Node>::const_iterator;
...
#endif // MARCO_DIALECT_BASEMODELICA_IR_VARIABLESDEPENDENCYGRAPH_H
