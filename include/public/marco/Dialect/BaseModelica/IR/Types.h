#ifndef MARCO_DIALECT_BASEMODELICA_IR_TYPES_H
#define MARCO_DIALECT_BASEMODELICA_IR_TYPES_H

#include "marco/Dialect/BaseModelica/IR/TypeInterfaces.h"
#include "mlir/IR/BuiltinOps.h"
#include "mlir/IR/Types.h"

namespace mlir::bmodelica {
enum class VariabilityProperty { none, discrete, parameter, constant };

enum class IOProperty { input, output, none };
...
class BaseArrayType : public mlir::Type,
                      public mlir::ShapedType::Trait<BaseArrayType> {
public:
...
public:
  ...
  Builder &setVariabilityProperty(VariabilityProperty newVariabilityProperty) {
  ...
  operator VariableType() {
    return VariableType::get(shape, elementType, variabilityProperty,
                             visibilityProperty, memorySpace);
  }
...
#endif // MARCO_DIALECT_BASEMODELICA_IR_TYPES_H
