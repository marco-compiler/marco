...
public:
  ...
  void addInductionVariable(mlir::Value inductionValue, uint64_t iterationSpace,
                            uint64_t dimension);

  [[nodiscard]] bool hasInductionVariable(mlir::Value induction) const;

  [[nodiscard]] const IndexSet &getInductionSpace(mlir::Value induction) const;
  ...
  void addDimensionDependency(uint64_t iterationSpace, uint64_t dimension,
                              uint64_t dependency);
...
public:
  ...
  getDerivative(mlir::Value original) const;

  void mapGenericOpDerivative(mlir::Operation *original,
                              mlir::Operation *mapped);

  [[nodiscard]] bool hasGenericOpDerivative(mlir::Operation *original) const;

  [[nodiscard]] std::optional<mlir::Operation *>
