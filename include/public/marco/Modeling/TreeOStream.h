#ifndef MARCO_MODELING_TREEOSTREAM_H
#define MARCO_MODELING_TREEOSTREAM_H
...
private:
  ...
  public:
    Buffer(std::streambuf *dest)
        : myDest(dest), lineIndicator(" |"), propertyIndicator("--"),
          newLine(false), property(false) {}

    void setProperty() { property = true; }
...
public:
  ...
  void setPropertyFlag() { buffer.setProperty(); }
...
#endif // MARCO_MODELING_TREEOSTREAM_H
