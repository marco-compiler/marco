...
namespace marco::modeling
{
  ...
  class AccessFunction
  {
    ...
    public:
      ...
      [[nodiscard]] virtual std::unique_ptr<AccessFunction> combine(
      ...
      [[nodiscard]] virtual IndexSet inverseMap(
      ...
      [[nodiscard]] virtual llvm::SmallVector<
          std::unique_ptr<DimensionAccess>, 6>
