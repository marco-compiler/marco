#ifndef MARCO_AST_BUILTINFUNCTION_FLOOR_H
#define MARCO_AST_BUILTINFUNCTION_FLOOR_H

#include "marco/AST/BuiltInFunction.h"

namespace marco::ast::builtin
{
  struct FloorFunction : public BuiltInFunction
  {
...
#endif // MARCO_AST_BUILTINFUNCTION_FLOOR_H
