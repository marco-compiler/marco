#ifndef MARCO_AST_BUILTINFUNCTION_INTEGER_H
#define MARCO_AST_BUILTINFUNCTION_INTEGER_H

#include "marco/AST/BuiltInFunction.h"

namespace marco::ast::builtin
{
  struct IntegerFunction : public BuiltInFunction
  {
...
#endif // MARCO_AST_BUILTINFUNCTION_INTEGER_H
