#ifndef MARCO_AST_BUILTINFUNTION_DIV_H
#define MARCO_AST_BUILTINFUNTION_DIV_H

#include "marco/AST/BuiltInFunction.h"

namespace marco::ast::builtin
{
  struct DivFunction : public BuiltInFunction
  {
...
#endif // MARCO_AST_BUILTINFUNTION_DIV_H
