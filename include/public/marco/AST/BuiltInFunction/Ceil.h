#ifndef MARCO_AST_BUILTINFUNCTION_CEIL_H
#define MARCO_AST_BUILTINFUNCTION_CEIL_H

#include "marco/AST/BuiltInFunction.h"

namespace marco::ast::builtin
{
  struct CeilFunction : public BuiltInFunction
  {
...
#endif // MARCO_AST_BUILTINFUNCTION_CEIL_H
