#ifndef MARCO_AST_BUILTINFUNTION_REM_H
#define MARCO_AST_BUILTINFUNTION_REM_H

#include "marco/AST/BuiltInFunction.h"

namespace marco::ast::builtin
{
  struct RemFunction : public BuiltInFunction
  {
...
#endif // MARCO_AST_BUILTINFUNTION_REM_H
