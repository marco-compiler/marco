#ifndef MARCO_AST_BUILTINFUNCTION_FILL_H
#define MARCO_AST_BUILTINFUNCTION_FILL_H

#include "marco/AST/BuiltInFunction.h"

namespace marco::ast::builtin
{
  struct FillFunction : public BuiltInFunction
  {
...
#endif // MARCO_AST_BUILTINFUNCTION_FILL_H
