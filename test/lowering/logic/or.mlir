...
func @test_staticArrays() -> () {
    ...
    %result = modelica.or %x, %y : (!modelica.array<stack, 4x!modelica.bool>, !modelica.array<stack, 4x!modelica.bool>) -> !modelica.array<stack, 4x!modelica.bool>
...
func @test_dynamicArrays() -> () {
    ...
    %result = modelica.or %x, %y : (!modelica.array<heap, ?x!modelica.bool>, !modelica.array<heap, ?x!modelica.bool>) -> !modelica.array<heap, ?x!modelica.bool>
