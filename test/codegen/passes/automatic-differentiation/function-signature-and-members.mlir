...
// CHECK-SAME: %[[DER_X:[a-zA-Z0-9]*]] : !modelica.ptr<2x!modelica.real>
// CHECK-SAME: %[[DER_Z:[a-zA-Z0-9]*]] : !modelica.real
// CHECK-SAME: %[[DER_2_X:[a-zA-Z0-9]*]] : !modelica.ptr<2x!modelica.real>
...
modelica.function @foo1(%arg0 : !modelica.ptr<2x!modelica.real>, %arg1 : !modelica.int, %arg2 : !modelica.real, %arg3 : !modelica.ptr<2x!modelica.real>, %arg4 : !modelica.real) -> (!modelica.real) attributes {args_names = ["x", "y", "z", "der_x", "der_z"], results_names = ["der_t"], derivative = #modelica.derivative<"foo2", 2>} {
    %0 = modelica.member_create {name = "t"} : !modelica.member<stack, !modelica.real>
