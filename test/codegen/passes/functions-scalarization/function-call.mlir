...
modelica.function @caller(%arg0 : !modelica.ptr<?x!modelica.real>) -> (!modelica.ptr<heap, ?x!modelica.real>) attributes {args_names = ["x"], results_names = ["y"]} {
    %0 = modelica.member_create {name = "y"} : !modelica.member<heap, ?x!modelica.real>
    %1 = modelica.call @callee(%arg0) : (!modelica.ptr<?x!modelica.real>) -> (!modelica.ptr<heap, ?x!modelica.real>)
