...
func.func @Scalar(%arg0: !bmodelica.real) -> !bmodelica.real {
    %0 = bmodelica.atan %arg0 : !bmodelica.real -> !bmodelica.real
    return %0 : !bmodelica.real

    // CHECK: %[[result:.*]] = bmodelica.atan %[[arg0]] : !bmodelica.real -> !bmodelica.real
...
func.func @Tensor(%arg0: tensor<2x3x!bmodelica.real>) -> tensor<2x3x!bmodelica.real> {
    %0 = bmodelica.atan %arg0 : tensor<2x3x!bmodelica.real> -> tensor<2x3x!bmodelica.real>
    return %0 : tensor<2x3x!bmodelica.real>

    // CHECK: %[[result:.*]] = bmodelica.atan %[[arg0]] : tensor<2x3x!bmodelica.real> -> tensor<2x3x!bmodelica.real>
    // CHECK-NEXT: return %[[result]]
}
