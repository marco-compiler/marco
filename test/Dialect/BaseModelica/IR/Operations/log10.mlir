...
func.func @Scalar(%arg0: !bmodelica.real) -> !bmodelica.real {
    ...
    // CHECK: %[[result:.*]] = bmodelica.log10 %[[arg0]] : !bmodelica.real -> !bmodelica.real
...
func.func @Tensor(%arg0: tensor<2x3x!bmodelica.real>) -> tensor<2x3x!bmodelica.real> {
    %0 = bmodelica.log10 %arg0 : tensor<2x3x!bmodelica.real> -> tensor<2x3x!bmodelica.real>
    return %0 : tensor<2x3x!bmodelica.real>

    // CHECK: %[[result:.*]] = bmodelica.log10 %[[arg0]] : tensor<2x3x!bmodelica.real> -> tensor<2x3x!bmodelica.real>
    // CHECK-NEXT: return %[[result]]
}
