...
func.func @Scalars(%arg0: !bmodelica.real, %arg1: !bmodelica.real) -> !bmodelica.real {
    %0 = bmodelica.min %arg0, %arg1 : !bmodelica.real, !bmodelica.real -> !bmodelica.real
    return %0 : !bmodelica.real

    // CHECK: %[[result:.*]] = bmodelica.min %[[arg0]], %[[arg1]] : !bmodelica.real, !bmodelica.real -> !bmodelica.real
...
func.func @Tensor(%arg0: tensor<?x?x!bmodelica.real>) -> !bmodelica.real {
    %0 = bmodelica.min %arg0 : tensor<?x?x!bmodelica.real> -> !bmodelica.real
    return %0 : !bmodelica.real

    // CHECK: %[[result:.*]] = bmodelica.min %[[arg0]] : tensor<?x?x!bmodelica.real> -> !bmodelica.real
    // CHECK-NEXT: return %[[result]]
}
