...
// CHECK:           %[[get:.*]] = bmodelica.qualified_variable_get @Test::@x : tensor<2x!bmodelica.real>
...
// CHECK:           %[[get:.*]] = bmodelica.qualified_variable_get @Test::@der_x : tensor<2x!bmodelica.real>
// CHECK:           %[[load:.*]] = bmodelica.tensor_extract %[[get]][%[[index]]]
// CHECK:           %[[cast:.*]] = bmodelica.cast %[[load]] : !bmodelica.real -> f64
// CHECK:           sundials.return %[[cast]]
// CHECK-NEXT:  }
...
// CHECK:           %[[get:.*]] = bmodelica.qualified_variable_get @Test::@x : tensor<2x3x!bmodelica.real>
...
// CHECK:           %[[get:.*]] = bmodelica.qualified_variable_get @Test::@der_x : tensor<2x3x!bmodelica.real>
// CHECK:           %[[load:.*]] = bmodelica.tensor_extract %[[get]][%[[index_0]], %[[index_1]]]
// CHECK:           %[[cast:.*]] = bmodelica.cast %[[load]] : !bmodelica.real -> f64
// CHECK:           sundials.return %[[cast]]
// CHECK-NEXT:  }
