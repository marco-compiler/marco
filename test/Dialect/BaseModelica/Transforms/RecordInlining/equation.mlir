...
bmodelica.model @componentsEquality {
    ...
    bmodelica.dynamic {
        bmodelica.equation {
            ...
            %2 = bmodelica.variable.get @r : !bmodelica<record @R>
...
bmodelica.model @recordsEquality {
    ...
    bmodelica.dynamic {
        bmodelica.equation {
            %0 = bmodelica.variable.get @r1 : !bmodelica<record @R>
            %1 = bmodelica.variable.get @r2 : !bmodelica<record @R>
            ...
            // CHECK-DAG:   %[[x_1:.*]] = bmodelica.variable.get @r1.x : !bmodelica.real
            // CHECK-DAG:   %[[y_1:.*]] = bmodelica.variable.get @r1.y : !bmodelica.real
            // CHECK-DAG:   %[[lhs:.*]] = bmodelica.equation_side %[[x_1]], %[[y_1]]
            // CHECK-DAG:   %[[x_2:.*]] = bmodelica.variable.get @r2.x : !bmodelica.real
            // CHECK-DAG:   %[[y_2:.*]] = bmodelica.variable.get @r2.y : !bmodelica.real
