...
bmodelica.model @Test {
    ...
    %t0 = bmodelica.equation_template inductions = [] attributes {id = "t0"} {
        ...
        %2 = bmodelica.tensor.extract %0[%1] : tensor<2x!bmodelica.real>
    ...
    %t1 = bmodelica.equation_template inductions = [] attributes {id = "t1"} {
        ...
        %3 = bmodelica.tensor.extract %0[%2] : tensor<2x!bmodelica.real>
    ...
    %t2 = bmodelica.equation_template inductions = [] attributes {id = "t2"} {
        ...
        %1 = bmodelica.variable.get @z : !bmodelica.real
    ...
    bmodelica.dynamic {
        ...
        // CHECK-DAG: bmodelica.equation_instance %[[t0]], match = <@x, {[0,0]}>
        // CHECK-DAG: bmodelica.equation_instance %[[t1]], match = <@x, {[1,1]}>
        // CHECK-DAG: bmodelica.equation_instance %[[t2]], match = @y
        // CHECK-DAG: bmodelica.equation_instance %[[t2]], match = @z
    }
}
