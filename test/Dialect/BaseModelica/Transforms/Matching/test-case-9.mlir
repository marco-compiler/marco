...
bmodelica.model @Test {
    ...
    %t1 = bmodelica.equation_template inductions = [] attributes {id = "t1"} {
        ...
        %6 = bmodelica.tensor.extract %0[%1] : tensor<5x!bmodelica.real>
        %7 = bmodelica.tensor.extract %0[%2] : tensor<5x!bmodelica.real>
        %8 = bmodelica.tensor.extract %0[%3] : tensor<5x!bmodelica.real>
        %9 = bmodelica.tensor.extract %0[%4] : tensor<5x!bmodelica.real>
        %10 = bmodelica.tensor.extract %0[%5] : tensor<5x!bmodelica.real>
