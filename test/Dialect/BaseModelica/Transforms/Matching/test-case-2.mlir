...
bmodelica.model @Test {
    ...
    bmodelica.dynamic {
        ...
        bmodelica.equation_instance %t1, indices = {[2,3]}

        // CHECK-DAG: bmodelica.matched_equation_instance %[[t0]], match = <@x, {[0,1]}> {indices = #modeling<multidim_range [0,1]>}
        // CHECK-DAG: bmodelica.matched_equation_instance %[[t1]], match = <@x, {[2,3]}> {indices = #modeling<multidim_range [2,3]>}
    }
}
