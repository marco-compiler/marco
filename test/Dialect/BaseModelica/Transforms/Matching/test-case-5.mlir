...
bmodelica.model @Test {
    ...
    %t1 = bmodelica.equation_template inductions = [%i0] attributes {id = "t1"} {
        ...
        %2 = bmodelica.tensor.extract %0[%i0] : tensor<4x!bmodelica.real>
        %3 = bmodelica.constant 1 : index
        %4 = bmodelica.add %i0, %3 : index, index -> index
        %5 = bmodelica.tensor.extract %1[%4] : tensor<5x!bmodelica.real>
    ...
    %t2 = bmodelica.equation_template inductions = [%i0] attributes {id = "t2"} {
        ...
        %3 = bmodelica.tensor.extract %0[%i0] : tensor<5x!bmodelica.real>
        %4 = bmodelica.tensor.extract %1[%i0] : tensor<5x!bmodelica.real>
        %5 = bmodelica.tensor.extract %2[%i0] : tensor<4x!bmodelica.real>
    ...
    %t3 = bmodelica.equation_template inductions = [] attributes {id = "t3"} {
        ...
        %3 = bmodelica.tensor.extract %0[%2] : tensor<5x!bmodelica.real>
        %4 = bmodelica.tensor.extract %1[%2] : tensor<5x!bmodelica.real>
