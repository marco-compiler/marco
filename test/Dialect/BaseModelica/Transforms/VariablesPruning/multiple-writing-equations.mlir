...
bmodelica.model @InitialWithDependency {
    ...
    %t2 = bmodelica.equation_template inductions = [] attributes {id = "t2"} {
        %0 = bmodelica.variable.get @z : !bmodelica.real
    ...
    bmodelica.initial {
        ...
        bmodelica.equation_instance %t2, match = @z
    }
    ...
    bmodelica.dynamic {
        bmodelica.equation_instance %t3, match = @z
    }

    // CHECK:       bmodelica.dynamic {
    // CHECK-DAG:       bmodelica.equation_instance %[[t3]], match = @z
    // CHECK-NEXT:  }
}
