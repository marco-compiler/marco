...
// CHECK-DAG:       %[[variable:.*]] = bmodelica.raw_variable {name = "x"} : memref<3x4xf64>
// CHECK-NEXT:      bmodelica.raw_variable_set %[[variable]], %[[arg0_to_buffer]] : memref<3x4xf64>, memref<3x4xf64, strided<[?, ?], offset: ?>>
...
// CHECK-DAG:       %[[variable:.*]] = bmodelica.raw_variable {name = "x"} : memref<3x?xf64>
// CHECK-NEXT:      bmodelica.raw_variable_set %[[variable]], %[[arg0_to_buffer]] : memref<3x?xf64>, memref<3x?xf64, strided<[?, ?], offset: ?>>
