// RUN: marco-opt %s --split-input-file --one-shot-bufferize | FileCheck %s
...
// CHECK-NEXT:      %[[result:.*]] = bmodelica.raw_variable.get %[[variable]] : memref<f64> -> f64
// CHECK-NEXT:      return %[[result]]
// CHECK-NEXT:  }

func.func @scalarVariableGet() -> f64 {
    %0 = bmodelica.raw_variable {name = "x"} : tensor<f64>
    %1 = bmodelica.raw_variable.get %0 : tensor<f64> -> f64
    func.return %1 : f64
}
...
// CHECK-SAME:  (%[[arg0:.*]]: f64)
// CHECK-NEXT:      %[[variable:.*]] = bmodelica.raw_variable {name = "x"} : memref<f64>
// CHECK-NEXT:      bmodelica.raw_variable.set %[[variable]], %[[arg0]] : memref<f64>, f64
// CHECK-NEXT:      return
// CHECK-NEXT:  }

func.func @scalarVariableSet(%arg0: f64) {
    %0 = bmodelica.raw_variable {name = "x"} : tensor<f64>
    bmodelica.raw_variable.set %0, %arg0 : tensor<f64>, f64
    func.return
}
...
// CHECK-NEXT:      %[[get:.*]] = bmodelica.raw_variable.get %[[variable]] : memref<3x4xf64> -> memref<3x4xf64>
...
func.func @staticArrayVariableGet() -> tensor<3x4xf64> {
    %0 = bmodelica.raw_variable {name = "x"} : tensor<3x4xf64>
    %1 = bmodelica.raw_variable.get %0 : tensor<3x4xf64> -> tensor<3x4xf64>
...
// CHECK-DAG:       %[[value:.*]] = bufferization.to_buffer %[[arg0]]
// CHECK-DAG:       %[[variable:.*]] = bmodelica.raw_variable {name = "x"} : memref<3x4xf64>
// CHECK:           bmodelica.raw_variable.set %[[variable]], %[[value]]
// CHECK-NEXT:      return
// CHECK-NEXT:  }

func.func @staticArrayVariableSet(%arg0: tensor<3x4xf64>) {
    %0 = bmodelica.raw_variable {name = "x"} : tensor<3x4xf64>
    bmodelica.raw_variable.set %0, %arg0 : tensor<3x4xf64>, tensor<3x4xf64>
    func.return
}
...
// CHECK-DAG:       %[[arg0_to_buffer:.*]] = bufferization.to_buffer %[[arg0]] : tensor<3x4xf64> to memref<3x4xf64, strided<[?, ?], offset: ?>>
// CHECK-DAG:       %[[variable:.*]] = bmodelica.raw_variable {name = "x"} : memref<3x4xf64>
// CHECK-NEXT:      bmodelica.raw_variable.set %[[variable]], %[[arg0_to_buffer]] : memref<3x4xf64>, memref<3x4xf64, strided<[?, ?], offset: ?>>
// CHECK-NEXT:      %[[result:.*]] = bmodelica.raw_variable.get %[[variable]] : memref<3x4xf64> -> memref<3x4xf64>
...
// CHECK-NEXT:      %[[get:.*]] = bmodelica.raw_variable.get %[[variable]] : memref<3x?xf64> -> memref<3x?xf64>
...
func.func @dynamicArrayVariableGet() -> tensor<3x?xf64> {
    %0 = bmodelica.raw_variable {name = "x"} : tensor<3x?xf64>
    %1 = bmodelica.raw_variable.get %0 : tensor<3x?xf64> -> tensor<3x?xf64>
...
func.func @dynamicArrayVariableSet(%arg0: tensor<3x?xf64>) {
    %0 = bmodelica.raw_variable {name = "x"} : tensor<3x?xf64>
    bmodelica.raw_variable.set %0, %arg0 : tensor<3x?xf64>, tensor<3x?xf64>
    func.return
}
...
// CHECK-DAG:       %[[arg0_to_buffer:.*]] = bufferization.to_buffer %[[arg0]] : tensor<3x?xf64> to memref<3x?xf64, strided<[?, ?], offset: ?>>
// CHECK-DAG:       %[[variable:.*]] = bmodelica.raw_variable {name = "x"} : memref<3x?xf64>
// CHECK-NEXT:      bmodelica.raw_variable.set %[[variable]], %[[arg0_to_buffer]] : memref<3x?xf64>, memref<3x?xf64, strided<[?, ?], offset: ?>>
// CHECK-NEXT:      %[[result:.*]] = bmodelica.raw_variable.get %[[variable]] : memref<3x?xf64> -> memref<3x?xf64>
