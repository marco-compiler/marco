...
func.func @test(%arg0: !bmodelica.array<2x3x4x5x6x!bmodelica.int>) -> (!bmodelica.int) {
    ...
    %5 = bmodelica.array.subscription %arg0[%0, %1] : !bmodelica.array<2x3x4x5x6x!bmodelica.int>, index, index -> !bmodelica.array<4x5x6x!bmodelica.int>
    %6 = bmodelica.array.subscription %5[%2, %3] : !bmodelica.array<4x5x6x!bmodelica.int>, index, index -> !bmodelica.array<6x!bmodelica.int>
    %7 = bmodelica.array.load %6[%4] : !bmodelica.array<6x!bmodelica.int>
    ...
    // CHECK: %[[result:.*]] = bmodelica.array.load %[[arg]][%[[cst_0]], %[[cst_1]], %[[cst_2]], %[[cst_3]], %[[cst_4]]]
    // CHECK: return %[[result]]
}
