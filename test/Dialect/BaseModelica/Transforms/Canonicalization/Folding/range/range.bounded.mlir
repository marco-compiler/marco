...
func.func @Integer() -> !bmodelica<range !bmodelica.int> {
    ...
    %3 = bmodelica.range.bounded %0, %1, %2 : !bmodelica.int, !bmodelica.int, !bmodelica.int -> !bmodelica<range !bmodelica.int>
...
func.func @Real() -> !bmodelica<range !bmodelica.real> {
    ...
    %3 = bmodelica.range.bounded %0, %1, %2 : !bmodelica.real, !bmodelica.real, !bmodelica.real -> !bmodelica<range !bmodelica.real>
...
func.func @Index() -> !bmodelica<range index> {
    ...
    %3 = bmodelica.range.bounded %0, %1, %2 : index, index, index -> !bmodelica<range index>
