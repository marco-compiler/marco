...
func.func @Integer() -> (!bmodelica.int) {
    ...
    // CHECK: %[[cst:.*]] = bmodelica.constant #bmodelica<int 6>
    // CHECK: return %[[cst]]
}
...
func.func @Real() -> (!bmodelica.real) {
    ...
    // CHECK: %[[cst:.*]] = bmodelica.constant #bmodelica<real 6.000000e+00>
    // CHECK: return %[[cst]]
}
...
func.func @mlirIndex() -> (index) {
    ...
    // CHECK: %[[cst:.*]] = bmodelica.constant 6 : index
    // CHECK: return %[[cst]]
}
...
func.func @mlirInteger() -> (i64) {
    ...
    // CHECK: %[[cst:.*]] = bmodelica.constant 6 : i64
    // CHECK: return %[[cst]]
}
...
func.func @mlirFloat() -> (f64) {
    ...
    // CHECK: %[[cst:.*]] = bmodelica.constant 6.000000e+00 : f64
    // CHECK: return %[[cst]]
}
