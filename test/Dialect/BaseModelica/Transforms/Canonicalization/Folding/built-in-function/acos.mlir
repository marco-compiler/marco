...
func.func @Test4() -> (!bmodelica.real) {
    ...
    // CHECK: %[[cst:.*]] = bmodelica.constant #bmodelica<real 2.356194489
    // CHECK: return %[[cst]]
}
...
func.func @Test5() -> (!bmodelica.real) {
    ...
    // CHECK: %[[cst:.*]] = bmodelica.constant #bmodelica<real 2.617993876
    // CHECK: return %[[cst]]
}
...
func.func @Test6() -> (!bmodelica.real) {
    ...
    // CHECK: %[[cst:.*]] = bmodelica.constant #bmodelica<real 3.1415926535897931>
    // CHECK: return %[[cst]]
}
