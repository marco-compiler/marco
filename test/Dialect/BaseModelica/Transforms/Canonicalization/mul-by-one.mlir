...
func.func @Integer(%0: !bmodelica.int) -> (!bmodelica.int) {
    ...
    %result = bmodelica.mul %0, %cst : (!bmodelica.int, !bmodelica.int) -> !bmodelica.int
...
func.func @Real(%0: !bmodelica.real) -> (!bmodelica.real) {
    ...
    %result = bmodelica.mul %0, %cst : (!bmodelica.real, !bmodelica.real) -> !bmodelica.real
...
func.func @IntegerReal(%0: !bmodelica.int) -> (!bmodelica.real) {
    %cst = bmodelica.constant #bmodelica<real 1.0>
    %result = bmodelica.mul %0, %cst : (!bmodelica.int, !bmodelica.real) -> !bmodelica.real
    return %result : !bmodelica.real
...
func.func @RealInteger(%0: !bmodelica.real) -> (!bmodelica.real) {
    %cst = bmodelica.constant #bmodelica<int 1>
    %result = bmodelica.mul %0, %cst : (!bmodelica.real, !bmodelica.int) -> !bmodelica.real
    return %result : !bmodelica.real
