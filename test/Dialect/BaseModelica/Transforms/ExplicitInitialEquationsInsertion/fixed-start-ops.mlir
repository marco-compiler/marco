...
bmodelica.model @arrayFixedScalarStart {
    ...
    // CHECK-DAG:       %[[x:.*]] = bmodelica.variable.get @x
    // CHECK-DAG:       %[[x_extract:.*]] = bmodelica.tensor.extract %[[x]][%[[i0]]]
    // CHECK-DAG:       %[[value:.*]] = bmodelica.constant #bmodelica<int 0>
...
bmodelica.model @arrayFixedArrayStart {
    ...
    // CHECK-DAG:       %[[tensor:.*]] = bmodelica.tensor.from_elements %[[value_0]], %[[value_1]], %[[value_2]]
    // CHECK-DAG:       %[[x_extract:.*]] = bmodelica.tensor.extract %[[x]][%[[i0]]]
    // CHECK-DAG:       %[[tensor_extract:.*]] = bmodelica.tensor.extract %[[tensor]][%[[i0]]]
