...
bmodelica.model @Test {
    ...
    %t0 = bmodelica.equation_template inductions = [%i0, %i1] {
        %0 = bmodelica.variable.get @x : tensor<2x3x!bmodelica.real>
        %1 = bmodelica.tensor.extract %0[%i0, %i1] : tensor<2x3x!bmodelica.real>
    ...
    // CHECK:       bmodelica.tensor.extract %{{.*}}[%[[i0]], %[[i1]]]
