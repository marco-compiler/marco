...
bmodelica.model @Backward {
    ...
    // CHECK-DAG:   bmodelica.matched_equation_instance %[[t0]], indices = {[1,9]}, match = <@x, {[1,9]}>
    // CHECK-DAG:   bmodelica.matched_equation_instance %[[t1]], indices = {}, match = <@x, {[0,0]}>
}
...
bmodelica.model @Forward {
    ...
    // CHECK:       bmodelica.dynamic
    // CHECK-DAG:   bmodelica.matched_equation_instance %[[t0]], indices = {[0,8]}, match = <@x, {[0,8]}>
    // CHECK-DAG:   bmodelica.matched_equation_instance %[[t1]], indices = {}, match = <@x, {[9,9]}>
}
