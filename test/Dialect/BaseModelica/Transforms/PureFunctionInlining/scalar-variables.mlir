// RUN: marco-opt %s --split-input-file --pure-function-inlining | FileCheck %s
...
bmodelica.model @scalarVariables {
    ...
    bmodelica.dynamic {
        bmodelica.equation {
            %0 = bmodelica.variable.get @a : !bmodelica.real
            %1 = bmodelica.variable.get @b : !bmodelica.real
            %2 = bmodelica.call @Foo(%0, %1) : (!bmodelica.real, !bmodelica.real) -> !bmodelica.real
            %3 = bmodelica.variable.get @c : !bmodelica.real
