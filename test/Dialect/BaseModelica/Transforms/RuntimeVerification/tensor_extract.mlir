...
// CHECK-LABEL: @Test
// CHECK-SAME: (%[[arg0:.*]]: tensor<3x?x!bmodelica.real>, %[[arg1:.*]]: index, %[[arg2:.*]]: index)

func.func @Test(%arg0: tensor<3x?x!bmodelica.real>, %arg1: index, %arg2: index) -> !bmodelica.real {
    ...
    // CHECK-NEXT:      %[[size:.*]] = bmodelica.size %[[arg0]], %[[constzero]] : (tensor<3x?x!bmodelica.real>, index) -> !bmodelica.int
    ...
    // CHECK-NEXT:      %[[size:.*]] = bmodelica.size %[[arg0]], %[[constone]] : (tensor<3x?x!bmodelica.real>, index) -> !bmodelica.int
    ...
    %0 = bmodelica.tensor_extract %arg0[%arg1, %arg2] : tensor<3x?x!bmodelica.real>
