...
func.func @Test(%arg0: !bmodelica.array<2x?x!bmodelica.int>, %arg1: index, %arg2: index) -> !bmodelica.int {
    ...
    // CHECK-NEXT:      %[[size:.*]] = bmodelica.size %[[conv]], %[[indexzero]] : (tensor<2x?x!bmodelica.int>, index) -> !bmodelica.int
    ...
    // CHECK-NEXT:      %[[size_2:.*]] = bmodelica.size %[[conv]], %[[indexzero_2]] : (tensor<2x?x!bmodelica.int>, index) -> !bmodelica.int
