...
func.func @Test(%arg0: !bmodelica.int) -> !bmodelica.real {
    ...
    // CHECK:       bmodelica.assert {level = 2 : i64, message = "Model error: Argument of asin outside the domain. It should be -1 <= arg <= 1"} {
    ...
    %0 = bmodelica.asin %arg0 : !bmodelica.int -> !bmodelica.real
