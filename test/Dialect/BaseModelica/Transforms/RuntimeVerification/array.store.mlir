...
// CHECK-LABEL: @Test
// CHECK-SAME: (%[[arg0:.*]]: !bmodelica.array<?x?xf64>, %[[arg1:.*]]: index, %[[arg2:.*]]: index, {{.*}}: f64)

func.func @Test(%arg0: !bmodelica.array<?x?xf64>, %arg1: index, %arg2: index, %arg3: f64) {
    ...
    // CHECK:  %[[dimSize:.*]] = bmodelica.array.dim %[[arg0]], %[[dimIndex]]
    ...
    bmodelica.array.store %arg0[%arg1, %arg2], %arg3 : !bmodelica.array<?x?xf64>
    func.return 
}
