...
bmodelica.model @Test {
    ...
    // CHECK:      %[[rhs:.*]] = bmodelica.variable_get @b : !bmodelica.int
    // CHECK-NEXT: bmodelica.assert {level = 2 : i64, message = "Model error: taking the remainder of a division by 0"} {
    ...
    %2 = bmodelica.mod %0, %1 : (!bmodelica.int, !bmodelica.int) -> !bmodelica.real
}
...
bmodelica.model @Test {
    ...
    // CHECK:      %[[rhs:.*]] = bmodelica.variable_get @b : !bmodelica.real
    // CHECK-NEXT: bmodelica.assert {level = 2 : i64, message = "Model error: taking the remainder of a division by 0"} {
    ...
    %2 = bmodelica.mod %0, %1 : (!bmodelica.real, !bmodelica.real) -> !bmodelica.real
}