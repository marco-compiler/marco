...
bmodelica.model @Test {
    ...
    %t1 = bmodelica.equation_template inductions = [] attributes {id = "t1"} {
        ...
        %1 = bmodelica.variable.get @x : tensor<10x!bmodelica.int>
        %2 = bmodelica.tensor.extract %1[%0] : tensor<10x!bmodelica.int>
