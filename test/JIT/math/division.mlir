...
func @test_integerScalars() -> () {
    ...
    %c1 = constant 1 : index
    %x1 = modelica.constant #modelica.int<15> : !modelica.int
    ...
    %c2 = constant 2 : index
    %x2 = modelica.constant #modelica.int<15> : !modelica.int
    ...
    %c3 = constant 3 : index
    %x3 = modelica.constant #modelica.int<-15> : !modelica.int
...
func @test_realScalars() -> () {
    ...
    %c1 = constant 1 : index
    %x1 = modelica.constant #modelica.real<15.5> : !modelica.real
    ...
    %c2 = constant 2 : index
    %x2 = modelica.constant #modelica.real<15.5> : !modelica.real
    ...
    %c3 = constant 3 : index
    %x3 = modelica.constant #modelica.real<-15.5> : !modelica.real
...
func @test_staticArrayAndScalar() -> () {
    %x = modelica.alloca : !modelica.array<stack, 3x!modelica.real>

    %c0 = constant 0 : index
    %x0 = modelica.constant #modelica.real<10.0> : !modelica.real
    modelica.store %x[%c0], %x0 : !modelica.array<stack, 3x!modelica.real>

    %c1 = constant 1 : index
    %x1 = modelica.constant #modelica.real<-2.0> : !modelica.real
    modelica.store %x[%c1], %x1 : !modelica.array<stack, 3x!modelica.real>

    %c2 = constant 2 : index
    %x2 = modelica.constant #modelica.real<0.0> : !modelica.real
    modelica.store %x[%c2], %x2 : !modelica.array<stack, 3x!modelica.real>

    %y = modelica.constant #modelica.real<2.0> : !modelica.real

    %result = modelica.div %x, %y : (!modelica.array<stack, 3x!modelica.real>, !modelica.real) -> !modelica.array<stack, 3x!modelica.real>
    modelica.print %result : !modelica.array<stack, 3x!modelica.real>
...
func @test_dynamicArrayAndScalar() -> () {
    ...
    %result = modelica.div %x, %y : (!modelica.array<stack, ?x!modelica.real>, !modelica.real) -> !modelica.array<stack, ?x!modelica.real>
