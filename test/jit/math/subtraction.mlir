...
func @test_staticIntegerArrays() -> () {
    ...
    %result = modelica.sub %x, %y : (!modelica.array<stack, 4x!modelica.int>, !modelica.array<stack, 4x!modelica.int>) -> !modelica.array<stack, 4x!modelica.int>
...
func @test_staticRealArrays() -> () {
    ...
    %result = modelica.sub %x, %y : (!modelica.array<stack, 4x!modelica.real>, !modelica.array<stack, 4x!modelica.real>) -> !modelica.array<stack, 4x!modelica.real>
...
func @test_dynamicIntegerArrays() -> () {
    ...
    %result = modelica.sub %x, %y : (!modelica.array<heap, ?x!modelica.int>, !modelica.array<heap, ?x!modelica.int>) -> !modelica.array<heap, ?x!modelica.int>
...
func @test_dynamicRealArrays() -> () {
    ...
    %result = modelica.sub %x, %y : (!modelica.array<heap, ?x!modelica.real>, !modelica.array<heap, ?x!modelica.real>) -> !modelica.array<heap, ?x!modelica.real>
