...
func.func @foo(%arg0 : !modelica.array<3x!modelica.int>, %arg1 : !modelica.array<3x!modelica.int>) -> !modelica.array<3x!modelica.int> {
    %0 = modelica.sub %arg0, %arg1 : (!modelica.array<3x!modelica.int>, !modelica.array<3x!modelica.int>) -> !modelica.array<3x!modelica.int>
...
func.func @foo(%arg0 : !modelica.array<3x!modelica.real>, %arg1 : !modelica.array<3x!modelica.real>) -> !modelica.array<3x!modelica.real> {
    %0 = modelica.sub %arg0, %arg1 : (!modelica.array<3x!modelica.real>, !modelica.array<3x!modelica.real>) -> !modelica.array<3x!modelica.real>
