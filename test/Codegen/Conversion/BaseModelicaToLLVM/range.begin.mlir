// RUN: marco-opt %s --split-input-file --convert-bmodelica-to-llvm | FileCheck %s
...
// CHECK: %[[result:.*]] = llvm.extractvalue %[[range_casted]][0]
...
func.func @foo(%arg0: !bmodelica<range !bmodelica.int>) -> !bmodelica.int {
    %0 = bmodelica.range.begin %arg0 : !bmodelica<range !bmodelica.int> -> !bmodelica.int
