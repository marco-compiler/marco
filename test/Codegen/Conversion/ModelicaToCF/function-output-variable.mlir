...
// CHECK-NEXT:      %[[x:.*]] = modelica.raw_variable : !modelica.member<!modelica.int, output> {name = "x"}
// CHECK-NEXT:      %[[result:.*]] = modelica.raw_variable_get %[[x]]
// CHECK-NEXT:      modelica.raw_return %[[result]]
// CHECK-NEXT:  }

modelica.function @scalarVariable {
    modelica.variable @x : !modelica.member<!modelica.int, output>
}
...
// CHECK-DAG:       %[[x:.*]] = modelica.raw_variable : !modelica.member<!modelica.int, output> {name = "x"}
...
// CHECK-NEXT:      %[[x:.*]] = modelica.raw_variable : !modelica.member<3x2x!modelica.int, output> {name = "x"}
// CHECK-NEXT:      %[[x_value:.*]] = modelica.raw_variable_get %[[x]]
// CHECK-NEXT:      modelica.raw_return %[[x_value]]
// CHECK-NEXT:  }

modelica.function @staticArray {
    modelica.variable @x : !modelica.member<3x2x!modelica.int, output>
}
...
// CHECK:           %[[x:.*]] = modelica.raw_variable : !modelica.member<3x2x!modelica.int, output> {name = "x"}
// CHECK-NEXT:      %[[x_value:.*]] = modelica.raw_variable_get %[[x]]
...
// CHECK-NEXT:      %[[x:.*]] = modelica.raw_variable : !modelica.member<3x?x!modelica.int, output> {name = "x"}
// CHECK-NEXT:      %[[result:.*]] = modelica.raw_variable_get %[[x]]
// CHECK-NEXT:      modelica.raw_return %[[result]]
// CHECK-NEXT:  }

modelica.function @dynamicArray {
    modelica.variable @x : !modelica.member<3x?x!modelica.int, output>
}
...
// CHECK:           %[[x:.*]] = modelica.raw_variable : !modelica.member<3x?x!modelica.int, output> {name = "x"}
// CHECK-NEXT:      %[[x_value:.*]] = modelica.raw_variable_get %[[x]]
// CHECK-NEXT:      %[[value:.*]] = modelica.load %[[x_value]][%{{.*}}, %{{.*}}]
...
// CHECK-DAG:       %[[x:.*]] = modelica.raw_variable : !modelica.member<3x!modelica.int, output> {name = "x"}
