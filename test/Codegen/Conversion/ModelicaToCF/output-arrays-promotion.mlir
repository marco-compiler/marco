...
// CHECK-LABEL: @callee
// CHECK-SAME: (%[[x:.*]]: !llvm.struct<(ptr<i64>, i64, array<1 x i64>)>) -> !llvm.struct<(ptr<i64>, i64, array<1 x i64>)>
// CHECK: %[[y:.*]] = modelica.alloc
// CHECK-SAME: !modelica.array<?x!modelica.int>
// CHECK: %[[y_cast:.*]] = builtin.unrealized_conversion_cast %[[y]] : !modelica.array<?x!modelica.int> to !llvm.struct<(ptr<i64>, i64, array<1 x i64>)>
// CHECK: return %[[y_cast]]
...
// CHECK: %[[x_cast:.*]] = builtin.unrealized_conversion_cast %[[x]] : !modelica.array<3x!modelica.int> to !llvm.struct<(ptr<i64>, i64, array<1 x i64>)>
