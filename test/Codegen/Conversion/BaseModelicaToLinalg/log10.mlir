...
// CHECK: %[[map:.*]] = linalg.map { bmodelica.log10 } ins(%[[arg0]] : tensor<3x4x5xf64>) outs(%[[destination]] : tensor<3x4x5xf64>)
// CHECK: return %[[map]]

func.func @foo(%arg0: tensor<3x4x5xf64>) -> (tensor<3x4x5xf64>) {
    %result = bmodelica.log10 %arg0 : tensor<3x4x5xf64> -> tensor<3x4x5xf64>
