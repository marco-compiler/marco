...
// CHECK: @foo(%[[arg0:.*]]: tensor<3x4x5xf64>, %[[arg1:.*]]: tensor<3x4x5xf64>)
// CHECK: %[[destination:.*]] = tensor.empty() : tensor<3x4x5xf64>
// CHECK: %[[map:.*]] = linalg.map { bmodelica.atan2 } ins(%[[arg0]], %[[arg1]] : tensor<3x4x5xf64>, tensor<3x4x5xf64>) outs(%[[destination]] : tensor<3x4x5xf64>)
// CHECK: return %[[map]]
