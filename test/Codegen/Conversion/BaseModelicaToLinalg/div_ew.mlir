...
// CHECK:   %[[result:.*]] = linalg.div ins(%[[arg0]], %[[arg1]] : tensor<3x4x5x6xi64>, tensor<3x4x5x6xi64>) outs(%[[destination]] : tensor<3x4x5x6xi64>) -> tensor<3x4x5x6xi64>
// CHECK:   return %[[result]]
...
// CHECK:   %[[destination:.*]] = tensor.empty()
// CHECK:   %[[result:.*]] = linalg.div ins(%[[splat]], %[[arg1]] : tensor<3x4x5x6xi64>, tensor<3x4x5x6xi64>) outs(%[[destination]] : tensor<3x4x5x6xi64>) -> tensor<3x4x5x6xi64>
// CHECK:   return %[[result]]
...
// CHECK:   %[[destination:.*]] = tensor.empty()
// CHECK:   %[[result:.*]] = linalg.div ins(%[[arg0]], %[[splat]] : tensor<3x4x5x6xi64>, tensor<3x4x5x6xi64>) outs(%[[destination]] : tensor<3x4x5x6xi64>) -> tensor<3x4x5x6xi64>
// CHECK:   return %[[result]]
