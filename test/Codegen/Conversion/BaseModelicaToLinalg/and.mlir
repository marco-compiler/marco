...
// CHECK:       %[[scalar_op:.*]] = bmodelica.and %[[in_0]], %[[in_1]]
// CHECK:       linalg.yield %[[scalar_op]]
// CHECK:   } -> tensor<3x4x5x6xi1>
// CHECK:   return %[[result]]

func.func @foo(%arg0 : tensor<3x4x5x6xi1>, %arg1 : tensor<3x4x5x6xi1>) -> tensor<3x4x5x6xi1> {
...
func.func @foo(%arg0 : tensor<3x?x5xi1>, %arg1 : tensor<3x?x5xi1>) -> tensor<3x?x5xi1> {
