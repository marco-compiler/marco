...
// CHECK: %[[map:.*]] = linalg.map { bmodelica.sign } ins(%[[arg0]] : tensor<3x4x5xf64>) outs(%[[destination]] : tensor<3x4x5xf64>)
// CHECK: return %[[map]]

func.func @foo(%arg0: tensor<3x4x5xf64>) -> (tensor<3x4x5xf64>) {
    %result = bmodelica.sign %arg0 : tensor<3x4x5xf64> -> tensor<3x4x5xf64>
