...
// CHECK: runtime.function private @_Mdiagonal_void_ai64_ai64(memref<*xi64>, tensor<*xi64>)

// CHECK-LABEL: @foo
// CHECK-SAME: (%[[arg0:.*]]: tensor<3xi64>) -> tensor<3x3xi64>
// CHECK: %[[alloc:.*]] = memref.alloc() : memref<3x3xi64>
// CHECK: %[[cast_1:.*]] = memref.cast %[[alloc]] : memref<3x3xi64> to memref<*xi64>
// CHECK: %[[cast_2:.*]] = tensor.cast %[[arg0]] : tensor<3xi64> to tensor<*xi64>
// CHECK: runtime.call @_Mdiagonal_void_ai64_ai64(%[[cast_1]], %[[cast_2]])
...
func.func @foo(%arg0: tensor<3xi64>) -> tensor<3x3xi64> {
    %0 = bmodelica.diagonal %arg0 : tensor<3xi64> -> tensor<3x3xi64>
