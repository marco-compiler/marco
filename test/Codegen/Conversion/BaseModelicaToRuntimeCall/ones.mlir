...
// CHECK: runtime.function private @_Mones_void_ai64(memref<*xi64>)
...
// CHECK: runtime.call @_Mones_void_ai64(%[[cast_1]])
...
func.func @foo(%arg0: index, %arg1: index) -> tensor<?x?xi64> {
    %0 = bmodelica.ones %arg0, %arg1 : (index, index) -> tensor<?x?xi64>
