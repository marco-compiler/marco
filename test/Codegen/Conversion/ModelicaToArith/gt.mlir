...
// CHECK: %[[cmp:.*]] = arith.cmpf ogt, %[[x_f64]], %[[y]] : f64
// CHECK: %[[result:.*]] =  builtin.unrealized_conversion_cast %[[cmp]] : i1 to !modelica.bool
// CHECK: return %[[result]] : !modelica.bool
...
// CHECK: %[[cmp:.*]] = arith.cmpf ogt, %[[x]], %[[y_f64]] : f64
// CHECK: %[[result:.*]] =  builtin.unrealized_conversion_cast %[[cmp]] : i1 to !modelica.bool
// CHECK: return %[[result]] : !modelica.bool
...
func.func @foo(%arg0 : index, %arg1 : index) -> i1 {
    %0 = modelica.gt %arg0, %arg1 : (index, index) -> i1
    func.return %0 : i1
}
...
func.func @foo(%arg0 : i64, %arg1 : i64) -> i1 {
    %0 = modelica.gt %arg0, %arg1 : (i64, i64) -> i1
    func.return %0 : i1
}
...
func.func @foo(%arg0 : f64, %arg1 : f64) -> i1 {
    %0 = modelica.gt %arg0, %arg1 : (f64, f64) -> i1
    func.return %0 : i1
}
