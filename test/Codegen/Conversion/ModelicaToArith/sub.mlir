...
func.func @foo(%arg0 : !modelica.real, %arg1 : !modelica.real) -> !modelica.real {
    %0 = modelica.sub %arg0, %arg1 : (!modelica.real, !modelica.real) -> !modelica.real
...
func.func @foo(%arg0 : !modelica.int, %arg1 : !modelica.real) -> !modelica.real {
    %0 = modelica.sub %arg0, %arg1 : (!modelica.int, !modelica.real) -> !modelica.real
    func.return %0 : !modelica.real
}
...
func.func @foo(%arg0 : !modelica.real, %arg1 : !modelica.int) -> !modelica.real {
    %0 = modelica.sub %arg0, %arg1 : (!modelica.real, !modelica.int) -> !modelica.real
    func.return %0 : !modelica.real
}
...
// CHECK:               %[[sub_casted:.*]] = builtin.unrealized_conversion_cast %[[sub]] : i64 to !modelica.int
// CHECK:               modelica.store %[[result]][%[[index_0]], %[[index_1]]], %[[sub_casted]]
// CHECK:           }
// CHECK:       }
// CHECK:       return %[[result]]
...
func.func @foo(%arg0 : !modelica.array<3x?x!modelica.int>, %arg1 : !modelica.array<3x?x!modelica.int>) -> !modelica.array<3x?x!modelica.int> {
    %0 = modelica.sub %arg0, %arg1 : (!modelica.array<3x?x!modelica.int>, !modelica.array<3x?x!modelica.int>) -> !modelica.array<3x?x!modelica.int>
...
// CHECK:               %[[sub_casted:.*]] = builtin.unrealized_conversion_cast %[[sub]] : f64 to !modelica.real
// CHECK:               modelica.store %[[result]][%[[index_0]], %[[index_1]]], %[[sub_casted]]
// CHECK:           }
// CHECK:       }
// CHECK:       return %[[result]]
...
func.func @foo(%arg0 : !modelica.array<3x?x!modelica.real>, %arg1 : !modelica.array<3x?x!modelica.real>) -> !modelica.array<3x?x!modelica.real> {
    %0 = modelica.sub %arg0, %arg1 : (!modelica.array<3x?x!modelica.real>, !modelica.array<3x?x!modelica.real>) -> !modelica.array<3x?x!modelica.real>
...
func.func @foo(%arg0 : index, %arg1 : index) -> index {
    %0 = modelica.sub %arg0, %arg1 : (index, index) -> index
    func.return %0 : index
}
...
func.func @foo(%arg0 : i64, %arg1 : i64) -> i64 {
    %0 = modelica.sub %arg0, %arg1 : (i64, i64) -> i64
    func.return %0 : i64
}
...
func.func @foo(%arg0 : f64, %arg1 : f64) -> f64 {
    %0 = modelica.sub %arg0, %arg1 : (f64, f64) -> f64
    func.return %0 : f64
}
