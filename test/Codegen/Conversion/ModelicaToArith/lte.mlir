...
func.func @foo(%arg0 : !modelica.int, %arg1 : !modelica.int) -> !modelica.bool {
    %0 = modelica.lte %arg0, %arg1 : (!modelica.int, !modelica.int) -> !modelica.bool
...
func.func @foo(%arg0 : !modelica.real, %arg1 : !modelica.real) -> !modelica.bool {
    %0 = modelica.lte %arg0, %arg1 : (!modelica.real, !modelica.real) -> !modelica.bool
    func.return %0 : !modelica.bool
}
...
func.func @foo(%arg0 : !modelica.int, %arg1 : !modelica.real) -> !modelica.bool {
    %0 = modelica.lte %arg0, %arg1 : (!modelica.int, !modelica.real) -> !modelica.bool
    func.return %0 : !modelica.bool
}
...
func.func @foo(%arg0 : !modelica.real, %arg1 : !modelica.int) -> !modelica.bool {
    %0 = modelica.lte %arg0, %arg1 : (!modelica.real, !modelica.int) -> !modelica.bool
    func.return %0 : !modelica.bool
}
...
func.func @foo(%arg0 : index, %arg1 : index) -> i1 {
    %0 = modelica.lte %arg0, %arg1 : (index, index) -> i1
    func.return %0 : i1
}
...
func.func @foo(%arg0 : i64, %arg1 : i64) -> i1 {
    %0 = modelica.lte %arg0, %arg1 : (i64, i64) -> i1
    func.return %0 : i1
}
...
func.func @foo(%arg0 : f64, %arg1 : f64) -> i1 {
    %0 = modelica.lte %arg0, %arg1 : (f64, f64) -> i1
    func.return %0 : i1
}
