...
// CHECK: %[[result:.*]] = arith.subi %[[arg0_casted]], %[[arg1_casted]] : i64
...
// CHECK: %[[result:.*]] = arith.subf %[[arg0_casted]], %[[arg1_casted]] : f64
...
// CHECK: %[[result:.*]] = arith.subf %[[arg0_f64]], %[[arg1_casted]] : f64
// CHECK: %[[result_casted:.*]] =  builtin.unrealized_conversion_cast %[[result]] : f64 to !bmodelica.real
// CHECK: return %[[result_casted]]

func.func @foo(%arg0 : !bmodelica.int, %arg1 : !bmodelica.real) -> !bmodelica.real {
    %0 = bmodelica.sub %arg0, %arg1 : (!bmodelica.int, !bmodelica.real) -> !bmodelica.real
    func.return %0 : !bmodelica.real
}
...
// CHECK: %[[result:.*]] = arith.subf %[[arg0_casted]], %[[arg1_f64]] : f64
// CHECK: %[[result_casted:.*]] =  builtin.unrealized_conversion_cast %[[result]] : f64 to !bmodelica.real
// CHECK: return %[[result_casted]]

func.func @foo(%arg0 : !bmodelica.real, %arg1 : !bmodelica.int) -> !bmodelica.real {
    %0 = bmodelica.sub %arg0, %arg1 : (!bmodelica.real, !bmodelica.int) -> !bmodelica.real
    func.return %0 : !bmodelica.real
}
...
// CHECK:               %[[sub:.*]] = arith.subi %[[lhs_casted]], %[[rhs_casted]] : i64
// CHECK:               %[[sub_casted:.*]] = builtin.unrealized_conversion_cast %[[sub]] : i64 to !bmodelica.int
// CHECK:               bmodelica.store %[[result]][%[[index_0]], %[[index_1]]], %[[sub_casted]]
// CHECK:           }
// CHECK:       }
// CHECK:       return %[[result]]
...
func.func @foo(%arg0 : !bmodelica.array<3x?x!bmodelica.int>, %arg1 : !bmodelica.array<3x?x!bmodelica.int>) -> !bmodelica.array<3x?x!bmodelica.int> {
    %0 = bmodelica.sub %arg0, %arg1 : (!bmodelica.array<3x?x!bmodelica.int>, !bmodelica.array<3x?x!bmodelica.int>) -> !bmodelica.array<3x?x!bmodelica.int>
...
// CHECK-LABEL: @foo
// CHECK-SAME: (%[[arg0:.*]]: !bmodelica.array<3x?x!bmodelica.real>, %[[arg1:.*]]: !bmodelica.array<3x?x!bmodelica.real>) -> !bmodelica.array<3x?x!bmodelica.real>
// CHECK-DAG:   %[[c0:.*]] = arith.constant 0 : index
// CHECK-DAG:   %[[c1:.*]] = arith.constant 1 : index
// CHECK-DAG:   %[[arg0_dim1:.*]] = bmodelica.dim %[[arg0]], %[[c1]]
// CHECK-DAG:   %[[arg1_dim1:.*]] = bmodelica.dim %[[arg1]], %[[c1]]
...
// CHECK:               %[[sub:.*]] = arith.subf %[[lhs_casted]], %[[rhs_casted]] : f64
// CHECK:               %[[sub_casted:.*]] = builtin.unrealized_conversion_cast %[[sub]] : f64 to !bmodelica.real
// CHECK:               bmodelica.store %[[result]][%[[index_0]], %[[index_1]]], %[[sub_casted]]
// CHECK:           }
// CHECK:       }
// CHECK:       return %[[result]]

func.func @foo(%arg0 : !bmodelica.array<3x?x!bmodelica.real>, %arg1 : !bmodelica.array<3x?x!bmodelica.real>) -> !bmodelica.array<3x?x!bmodelica.real> {
    %0 = bmodelica.sub %arg0, %arg1 : (!bmodelica.array<3x?x!bmodelica.real>, !bmodelica.array<3x?x!bmodelica.real>) -> !bmodelica.array<3x?x!bmodelica.real>
...
// CHECK: %[[result:.*]] = arith.subi %[[arg0]], %[[arg1]] : index
// CHECK: return %[[result]] : index

func.func @foo(%arg0 : index, %arg1 : index) -> index {
    %0 = bmodelica.sub %arg0, %arg1 : (index, index) -> index
    func.return %0 : index
}
...
// CHECK: %[[result:.*]] = arith.subi %[[arg0]], %[[arg1]] : i64
// CHECK: return %[[result]] : i64

func.func @foo(%arg0 : i64, %arg1 : i64) -> i64 {
    %0 = bmodelica.sub %arg0, %arg1 : (i64, i64) -> i64
    func.return %0 : i64
}
...
// CHECK: %[[result:.*]] = arith.subf %[[arg0]], %[[arg1]] : f64
// CHECK: return %[[result]] : f64

func.func @foo(%arg0 : f64, %arg1 : f64) -> f64 {
    %0 = bmodelica.sub %arg0, %arg1 : (f64, f64) -> f64
    func.return %0 : f64
}
