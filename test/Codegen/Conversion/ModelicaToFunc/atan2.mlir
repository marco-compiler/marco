...
// CHECK: modelica.runtime_function @_Matan2_f64_f64_f64 : (f64, f64) -> f64
...
// CHECK: %[[result:.*]] = modelica.call @_Matan2_f64_f64_f64(%[[arg0_casted]], %[[arg1_casted]]) : (f64, f64) -> f64
...
func.func @test(%arg0: !modelica.real, %arg1: !modelica.real) -> !modelica.real {
    %0 = modelica.atan2 %arg0, %arg1 : (!modelica.real, !modelica.real) -> !modelica.real
