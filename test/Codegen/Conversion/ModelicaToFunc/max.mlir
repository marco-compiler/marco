...
// CHECK: modelica.runtime_function @_MmaxArray_i64_ai64 : (memref<*xi64>) -> i64
// CHECK-LABEL: @test
...
// CHECK: %[[result:.*]] = modelica.call @_MmaxArray_i64_ai64(%[[arg0_unranked]]) : (memref<*xi64>) -> i64
...
func.func @test(%arg0: !modelica.array<5x3x!modelica.int>) -> !modelica.int {
    %0 = modelica.max %arg0 : !modelica.array<5x3x!modelica.int> -> !modelica.int
    func.return %0 : !modelica.int
}

// -----

// CHECK: modelica.runtime_function @_MmaxScalars_i64_i64_i64 : (i64, i64) -> i64
// CHECK-LABEL: @test
...
// CHECK: %[[result:.*]] = modelica.call @_MmaxScalars_i64_i64_i64(%[[arg0_casted]], %[[arg1_casted]]) : (i64, i64) -> i64
// CHECK: %[[result_casted:.*]] = builtin.unrealized_conversion_cast %[[result]] : i64 to !modelica.int
// CHECK: return %[[result_casted]]

func.func @test(%arg0: !modelica.int, %arg1: !modelica.int) -> !modelica.int {
    %0 = modelica.max %arg0, %arg1 : (!modelica.int, !modelica.int) -> !modelica.int
    func.return %0 : !modelica.int
}
