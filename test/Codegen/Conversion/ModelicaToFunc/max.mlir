...
// CHECK: modelica.runtime_function @maxArray : (memref<*xi64>) -> i64
// CHECK-LABEL: @test
...
// CHECK: %[[result:.*]] = modelica.call @maxArray(%[[arg0_unranked]]) : (memref<*xi64>) -> i64
...
// CHECK: modelica.runtime_function @maxScalars : (i64, i64) -> i64
// CHECK-LABEL: @test
...
// CHECK: %[[result:.*]] = modelica.call @maxScalars(%[[arg0_casted]], %[[arg1_casted]]) : (i64, i64) -> i64
// CHECK: %[[result_casted:.*]] = builtin.unrealized_conversion_cast %[[result]] : i64 to !modelica.int
// CHECK: return %[[result_casted]]
