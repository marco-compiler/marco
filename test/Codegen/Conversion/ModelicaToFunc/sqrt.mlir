...
// CHECK: modelica.runtime_function @_Msqrt_f64_f64 : (f64) -> f64
...
// CHECK: %[[result:.*]] = modelica.call @_Msqrt_f64_f64(%[[arg0_casted]]) : (f64) -> f64
...
func.func @test(%arg0: !modelica.real) -> !modelica.real {
    %0 = modelica.sqrt %arg0 : !modelica.real -> !modelica.real
