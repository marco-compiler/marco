...
// CHECK: modelica.runtime_function @rem : (i64, i64) -> i64
...
// CHECK: %[[result:.*]] = modelica.call @rem(%[[arg0_casted]], %[[arg1_casted]]) : (i64, i64) -> i64
...
// CHECK: modelica.runtime_function @rem : (f64, f64) -> f64
...
// CHECK: %[[result:.*]] = modelica.call @rem(%[[arg0_casted]], %[[arg1_casted]]) : (f64, f64) -> f64
...
// CHECK-DAG: %[[arg1_casted:.*]] = builtin.unrealized_conversion_cast %[[arg1]] : !modelica.real to f64
// CHECK: %[[result:.*]] = modelica.call @rem(%[[arg0_casted_2]], %[[arg1_casted]]) : (f64, f64) -> f64
// CHECK: %[[result_casted:.*]] = builtin.unrealized_conversion_cast %[[result]] : f64 to !modelica.real
// CHECK: return %[[result_casted]]
...
// CHECK: %[[result:.*]] = modelica.call @rem(%[[arg0_casted]], %[[arg1_casted_2]]) : (f64, f64) -> f64
// CHECK: %[[result_casted:.*]] = builtin.unrealized_conversion_cast %[[result]] : f64 to !modelica.real
// CHECK: return %[[result_casted]]
