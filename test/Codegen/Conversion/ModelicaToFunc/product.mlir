...
// CHECK: modelica.runtime_function @_Mproduct_i64_ai64 : (memref<*xi64>) -> i64
// CHECK-LABEL: @test
...
// CHECK: %[[result:.*]] = modelica.call @_Mproduct_i64_ai64(%[[arg0_unranked]]) : (memref<*xi64>) -> i64
...
func.func @test(%arg0: !modelica.array<5x3x!modelica.int>) -> !modelica.int {
    %0 = modelica.product %arg0 : !modelica.array<5x3x!modelica.int> -> !modelica.int
