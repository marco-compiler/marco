...
// CHECK: func.func private @_Mproduct_i64_ai64(memref<*xi64>) -> i64
// CHECK-LABEL: @test
...
// CHECK: %[[result:.*]] = call @_Mproduct_i64_ai64(%[[arg0_unranked]]) : (memref<*xi64>) -> i64
...
func.func @test(%arg0: !bmodelica.array<5x3x!bmodelica.int>) -> !bmodelica.int {
    %0 = bmodelica.product %arg0 : !bmodelica.array<5x3x!bmodelica.int> -> !bmodelica.int
