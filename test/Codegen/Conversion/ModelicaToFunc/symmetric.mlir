...
// CHECK: modelica.runtime_function @_Msymmetric_void_ai64_ai64 : (memref<*xi64>, memref<*xi64>) -> ()
...
// CHECK: modelica.call @_Msymmetric_void_ai64_ai64(%[[result_unranked]], %[[arg0_unranked]]) : (memref<*xi64>, memref<*xi64>) -> ()
// CHECK: return %[[result]]

func.func @test(%arg0: !modelica.array<3x3x!modelica.int>) -> !modelica.array<3x3x!modelica.int> {
    %0 = modelica.symmetric %arg0 : !modelica.array<3x3x!modelica.int> -> !modelica.array<3x3x!modelica.int>
