...
// CHECK: modelica.runtime_function @_Mfloor_f64_f64 : (f64) -> f64
...
// CHECK: %[[result:.*]] = modelica.call @_Mfloor_f64_f64(%[[arg0_casted]]) : (f64) -> f64
...
func.func @test(%arg0: !modelica.real) -> !modelica.real {
    %0 = modelica.floor %arg0 : !modelica.real -> !modelica.real
