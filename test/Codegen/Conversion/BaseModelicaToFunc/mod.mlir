...
// CHECK: func.func private @_Mmod_i64_i64_i64(i64, i64) -> i64
...
// CHECK: %[[result:.*]] = call @_Mmod_i64_i64_i64(%[[arg0_casted]], %[[arg1_casted]]) : (i64, i64) -> i64
...
func.func @integers(%arg0: !bmodelica.int, %arg1: !bmodelica.int) -> !bmodelica.int {
    %0 = bmodelica.mod %arg0, %arg1 : (!bmodelica.int, !bmodelica.int) -> !bmodelica.int
    func.return %0 : !bmodelica.int
}

// -----

// CHECK: func.func private @_Mmod_f64_f64_f64(f64, f64) -> f64
...
// CHECK: %[[result:.*]] = call @_Mmod_f64_f64_f64(%[[arg0_casted]], %[[arg1_casted]]) : (f64, f64) -> f64
...
// CHECK-DAG: %[[arg1_casted:.*]] = builtin.unrealized_conversion_cast %[[arg1]] : !bmodelica.real to f64
// CHECK: %[[result:.*]] = call @_Mmod_f64_f64_f64(%[[arg0_casted_2]], %[[arg1_casted]]) : (f64, f64) -> f64
// CHECK: %[[result_casted:.*]] = builtin.unrealized_conversion_cast %[[result]] : f64 to !bmodelica.real
// CHECK: return %[[result_casted]]

func.func @integerReal(%arg0: !bmodelica.int, %arg1: !bmodelica.real) -> !bmodelica.real {
    %0 = bmodelica.mod %arg0, %arg1 : (!bmodelica.int, !bmodelica.real) -> !bmodelica.real
    func.return %0 : !bmodelica.real
}
...
// CHECK: %[[result:.*]] = call @_Mmod_f64_f64_f64(%[[arg0_casted]], %[[arg1_casted_2]]) : (f64, f64) -> f64
// CHECK: %[[result_casted:.*]] = builtin.unrealized_conversion_cast %[[result]] : f64 to !bmodelica.real
// CHECK: return %[[result_casted]]

func.func @realInteger(%arg0: !bmodelica.real, %arg1: !bmodelica.int) -> !bmodelica.real {
    %0 = bmodelica.mod %arg0, %arg1 : (!bmodelica.real, !bmodelica.int) -> !bmodelica.real
    func.return %0 : !bmodelica.real
}
