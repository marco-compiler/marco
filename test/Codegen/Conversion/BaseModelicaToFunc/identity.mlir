...
// CHECK-LABEL: @test
// CHECK-SAME: (%[[arg0:.*]]: index) -> !bmodelica.array<?x?x!bmodelica.int>
// CHECK-DAG: %[[result:.*]] = bmodelica.alloc %[[arg0]], %[[arg0]] : <?x?x!bmodelica.int>
...
func.func @test(%arg0: index) -> !bmodelica.array<?x?x!bmodelica.int> {
    %0 = bmodelica.identity %arg0 : index -> !bmodelica.array<?x?x!bmodelica.int>
