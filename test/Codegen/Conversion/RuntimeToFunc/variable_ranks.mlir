// RUN: modelica-opt %s --split-input-file --convert-runtime-to-func | FileCheck %s --check-prefix="CHECK-VAR-UNKNOWN"
// RUN: modelica-opt %s --split-input-file --convert-runtime-to-func | FileCheck %s --check-prefix="CHECK-VAR-0"
// RUN: modelica-opt %s --split-input-file --convert-runtime-to-func | FileCheck %s --check-prefix="CHECK-VAR-1"
// RUN: modelica-opt %s --split-input-file --convert-runtime-to-func | FileCheck %s --check-prefix="CHECK-VAR-2"
...
#var0 = #runtime.variable<name = "var0">
#var1 = #runtime.variable<name = "var1", dimensions = [3]>
#var2 = #runtime.variable<name = "var2", dimensions = [3, 5]>
