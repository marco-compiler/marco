// RUN: marco-opt %s --split-input-file --convert-runtime-to-func --canonicalize | FileCheck %s
...
// CHECK-DAG:       %[[array:.*]] = bmodelica.array.alloc : <2x3x4x!bmodelica.real>
...
// CHECK:           %[[load:.*]] = bmodelica.array.load %[[array]][%[[i0]], %[[i1]], %[[i2]]]
...
runtime.variable_getter @getter(%arg0: index, %arg1: index, %arg2: index) -> f64 {
    %0 = bmodelica.array.alloc : <2x3x4x!bmodelica.real>
    %1 = bmodelica.array.load %0[%arg0, %arg1, %arg2] : !bmodelica.array<2x3x4x!bmodelica.real>
