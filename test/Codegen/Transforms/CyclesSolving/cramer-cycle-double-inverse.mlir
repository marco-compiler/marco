...
^bb0(%arg0: !modelica.array<!modelica.real>, %arg1: !modelica.array<!modelica.real>, %arg2: !modelica.array<!modelica.real>, %arg3: !modelica.array<!modelica.real>, %arg4: !modelica.array<!modelica.real>, %arg5: !modelica.array<!modelica.real>):
  ...
  modelica.equation attributes {id = 3, match = [{indices = [[[0, 0]]], path = ["L", 0 : index, 0 : index, 0 : index, 1 : index]}]} {
    %0 = modelica.constant #modelica.int<1> : !modelica.int
    %1 = modelica.constant #modelica.int<2> : !modelica.int
    %2 = modelica.load %arg1[] : !modelica.array<!modelica.real>
    %3 = modelica.load %arg0[] : !modelica.array<!modelica.real>
    %4 = modelica.add %3, %2 : (!modelica.real, !modelica.real) -> !modelica.real
    %5 = modelica.load %arg2[] : !modelica.array<!modelica.real>
    %6 = modelica.add %4, %5 : (!modelica.real, !modelica.real) -> !modelica.real
    %7 = modelica.load %arg4[] : !modelica.array<!modelica.real>
    %8 = modelica.sub %6, %7 : (!modelica.real, !modelica.real) -> !modelica.real
    %9 = modelica.load %arg5[] : !modelica.array<!modelica.real>
    %10 = modelica.mul %1, %9 : (!modelica.int, !modelica.real) -> !modelica.real
    %11 = modelica.add %8, %10 : (!modelica.real, !modelica.real) -> !modelica.real
    %12 = modelica.equation_side %11 : tuple<!modelica.real>
    %13 = modelica.equation_side %0 : tuple<!modelica.int>
    modelica.equation_sides %12, %13 : tuple<!modelica.real>, tuple<!modelica.int>
  }
  modelica.equation attributes {id = 4, match = [{indices = [[[0, 0]]], path = ["L", 0 : index, 0 : index]}]} {
    %0 = modelica.constant #modelica.int<2> : !modelica.int
