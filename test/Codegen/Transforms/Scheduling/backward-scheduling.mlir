...
// CHECK-NEXT:          }
// CHECK-NEXT:          modelica.scc {
// CHECK-NEXT:              modelica.scheduled_equation_instance %[[t0]] {indices = #modeling<multidim_range [0,8]>, iteration_directions = [#modelica<equation_schedule_direction backward>], path = #modelica<equation_path [L, 0]>}
// CHECK-NEXT:          }
// CHECK-NEXT:      }
// CHECK-NEXT:  }
