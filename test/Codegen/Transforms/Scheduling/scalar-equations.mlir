...
// CHECK{LITERAL}: {id = 1 : i64, scheduled_direction = "forward", scheduled_indices = [[0, 1]]}
// CHECK{LITERAL}: {id = 0 : i64, scheduled_direction = "forward", scheduled_indices = [[0, 1]]}
...
^bb0(%arg0: !modelica.array<!modelica.int>, %arg1: !modelica.array<!modelica.int>):
    modelica.equation attributes {id = 0, matched_path = ["R"], matched_indices = [[0, 1]]} {
    ...
    modelica.equation attributes {id = 1, matched_path = ["L"], matched_indices = [[0, 1]]} {
        %0 = modelica.load %arg1[] : !modelica.array<!modelica.int>
