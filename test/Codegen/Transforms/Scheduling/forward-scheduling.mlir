...
// CHECK-NEXT:      modelica.scc {
// CHECK-NEXT:          modelica.scheduled_equation_instance %[[t0]] {indices = #modeling<multidim_range [1,8]>, iteration_directions = [#modelica<equation_schedule_direction forward>], path = #modelica<equation_path [L, 0]>}
// CHECK-NEXT:      }
// CHECK-NEXT:  }
// CHECK-NEXT:  modelica.scc_group {
// CHECK-NEXT:      modelica.scc {
// CHECK-NEXT:          modelica.scheduled_equation_instance %[[t0]] {indices = #modeling<multidim_range [9,9]>, iteration_directions = [#modelica<equation_schedule_direction forward>], path = #modelica<equation_path [L, 0]>}
// CHECK-NEXT:      }
// CHECK-NEXT:  }
...
modelica.model @Test {
    ...
    %t1 = modelica.equation_template inductions = [] attributes {id = "t1"} {
        ...
        %1 = modelica.variable_get @x : !modelica.array<10x!modelica.int>
