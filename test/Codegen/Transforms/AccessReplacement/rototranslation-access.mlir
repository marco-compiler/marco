...
bmodelica.model @Test {
    ...
    // CHECK-DAG:       %[[z_load:.*]] = bmodelica.load %[[z]][%[[z_index_0]], %[[z_index_1]], %[[z_index_2]]]
    ...
    %t0 = bmodelica.equation_template inductions = [%i0, %i1, %i2] attributes {id = "t0"} {
        ...
        %8 = bmodelica.load %0[%i0, %i1, %i2] : !bmodelica.array<50x50x50x!bmodelica.real>
        %9 = bmodelica.load %1[%5, %6, %7] : !bmodelica.array<50x50x50x!bmodelica.real>
    ...
    %t1 = bmodelica.equation_template inductions = [%i0, %i1, %i2] attributes {id = "t1"} {
        ...
        %8 = bmodelica.load %0[%5, %6, %7] : !bmodelica.array<50x50x50x!bmodelica.real>
        %9 = bmodelica.load %1[%i0, %i1, %i2] : !bmodelica.array<50x50x50x!bmodelica.real>
        %10 = bmodelica.equation_side %8 : tuple<!bmodelica.real>
        %11 = bmodelica.equation_side %9 : tuple<!bmodelica.real>
        bmodelica.equation_sides %10, %11 : tuple<!bmodelica.real>, tuple<!bmodelica.real>
    }
    ...
    bmodelica.dynamic {
        ...
        bmodelica.equation_instance %t1 {id = "eq1", indices = #modeling<multidim_range [10,20][10,20][10,20]>} : !bmodelica.equation
    }
}
