...
// CHECK: %[[result:.*]] = modelica.subscription %[[arg]][%[[cst_0]], %[[cst_1]], %[[cst_2]], %[[cst_3]]]
// CHECK: return %[[result]]

func.func @test(%arg0: !modelica.array<2x3x4x5x6x!modelica.int>) -> (!modelica.array<6x!modelica.int>) {
    ...
    return %6 : !modelica.array<6x!modelica.int>
}
