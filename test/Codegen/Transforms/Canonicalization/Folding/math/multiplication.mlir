...
// CHECK-LABEL: @test
// CHECK-NEXT: %[[cst:.*]] = modelica.constant #modelica.int<6>
...
// CHECK-LABEL: @test
// CHECK-NEXT: %[[cst:.*]] = modelica.constant #modelica.real<6.000000e+00>
// CHECK-NEXT: return %[[cst]]
...
func.func @test() -> (!modelica.real) {
    %x = modelica.constant #modelica.int<3>
    %y = modelica.constant #modelica.real<2.0>
    %result = modelica.mul %x, %y : (!modelica.int, !modelica.real) -> !modelica.real
    return %result : !modelica.real
}
...
// CHECK-LABEL: @test
// CHECK-NEXT: %[[cst:.*]] = modelica.constant 6 : index
// CHECK-NEXT: return %[[cst]]

func.func @test() -> (index) {
    %x = modelica.constant 3 : index
    %y = modelica.constant 2 : index
    %result = modelica.mul %x, %y : (index, index) -> index
    return %result : index
}
...
// CHECK-LABEL: @test
// CHECK-NEXT: %[[cst:.*]] = modelica.constant 6 : i64
// CHECK-NEXT: return %[[cst]]

func.func @test() -> (i64) {
    %x = modelica.constant 3 : i64
    %y = modelica.constant 2 : i64
    %result = modelica.mul %x, %y : (i64, i64) -> i64
    return %result : i64
}
...
// CHECK-LABEL: @test
// CHECK-NEXT: %[[cst:.*]] = modelica.constant 6.000000e+00 : f64
// CHECK-NEXT: return %[[cst]]

func.func @test() -> (f64) {
    %x = modelica.constant 3.0 : f64
    %y = modelica.constant 2.0 : f64
    %result = modelica.mul %x, %y : (f64, f64) -> f64
    return %result : f64
}
