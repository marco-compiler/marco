...
func.func @test_integerScalars_firstGreater() -> (!modelica.bool) {
    %x = modelica.constant #modelica.int<10>
    %y = modelica.constant #modelica.int<9>
    %result = modelica.gte %x, %y : (!modelica.int, !modelica.int) -> !modelica.bool
...
func.func @test_integerScalars_secondGreater() -> (!modelica.bool) {
...
func.func @test_realScalars_firstGreater() -> (!modelica.bool) {
    %x = modelica.constant #modelica.real<10.0>
    %y = modelica.constant #modelica.real<9.0>
    %result = modelica.gte %x, %y : (!modelica.real, !modelica.real) -> !modelica.bool
    return %result : !modelica.bool
}
...
func.func @test_realScalars_secondGreater() -> (!modelica.bool) {
...
func.func @test_mixedScalars_integerReal_firstGreater() -> (!modelica.bool) {
    %x = modelica.constant #modelica.int<10>
    %y = modelica.constant #modelica.real<9.7>
    %result = modelica.gte %x, %y : (!modelica.int, !modelica.real) -> !modelica.bool
    return %result : !modelica.bool
}
...
func.func @test_mixedScalars_integerReal_secondGreater() -> (!modelica.bool) {
    %x = modelica.constant #modelica.int<9>
    %y = modelica.constant #modelica.real<9.7>
    %result = modelica.gte %x, %y : (!modelica.int, !modelica.real) -> !modelica.bool
    return %result : !modelica.bool
...
func.func @test_mixedScalars_realInteger_firstGreater() -> (!modelica.bool) {
    %x = modelica.constant #modelica.real<9.7>
    %y = modelica.constant #modelica.int<9>
    %result = modelica.gte %x, %y : (!modelica.real, !modelica.int) -> !modelica.bool
    return %result : !modelica.bool
}
...
func.func @test_mixedScalars_realInteger_secondGreater() -> (!modelica.bool) {
    %x = modelica.constant #modelica.real<9.7>
    %y = modelica.constant #modelica.int<10>
    %result = modelica.gte %x, %y : (!modelica.real, !modelica.int) -> !modelica.bool
    return %result : !modelica.bool
