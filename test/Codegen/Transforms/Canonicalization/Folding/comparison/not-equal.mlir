...
func.func @test_integerScalars_true() -> (!modelica.bool) {
    %x = modelica.constant #modelica.int<10>
    %y = modelica.constant #modelica.int<9>
    %result = modelica.neq %x, %y : (!modelica.int, !modelica.int) -> !modelica.bool
...
func.func @test_integerScalars_false() -> (!modelica.bool) {
    %x = modelica.constant #modelica.int<10>
...
func.func @test_realScalars_true() -> (!modelica.bool) {
    %x = modelica.constant #modelica.real<10.0>
    %y = modelica.constant #modelica.real<9.0>
    %result = modelica.neq %x, %y : (!modelica.real, !modelica.real) -> !modelica.bool
    return %result : !modelica.bool
}
...
func.func @test_realScalars_false() -> (!modelica.bool) {
    %x = modelica.constant #modelica.real<10.0>
...
func.func @test_mixedScalars_integerReal_true() -> (!modelica.bool) {
    %x = modelica.constant #modelica.int<10>
    %y = modelica.constant #modelica.real<9.7>
    %result = modelica.neq %x, %y : (!modelica.int, !modelica.real) -> !modelica.bool
    return %result : !modelica.bool
}
...
func.func @test_mixedScalars_integerReal_false() -> (!modelica.bool) {
    %x = modelica.constant #modelica.int<10>
    %y = modelica.constant #modelica.real<10.0>
    %result = modelica.neq %x, %y : (!modelica.int, !modelica.real) -> !modelica.bool
    return %result : !modelica.bool
...
func.func @test_mixedScalars_integerReal_true() -> (!modelica.bool) {
    ...
    %y = modelica.constant #modelica.int<10>
    %result = modelica.neq %x, %y : (!modelica.real, !modelica.int) -> !modelica.bool
    return %result : !modelica.bool
}
