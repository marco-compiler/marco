...
// CHECK-NEXT:                  simulation.scheduler_run @[[scheduler_0:.*]]
// CHECK-NEXT:              } {readVariables = [], writtenVariables = [#modelica.var<@x, #[[index_set]]>]}
// CHECK-NEXT:          }
// CHECK-NEXT:          modelica.parallel_schedule_blocks {
// CHECK-NEXT:              modelica.schedule_block {
// CHECK-NEXT:                  simulation.scheduler_run @[[scheduler_1:.*]]
// CHECK-NEXT:              } {readVariables = [], writtenVariables = [#modelica.var<@y, #[[index_set]]>]}
// CHECK-NEXT:          }
// CHECK-NEXT:      }
// CHECK-NEXT:  }

// CHECK:       simulation.scheduler @[[scheduler_0]]

// CHECK:       simulation.dynamic_model_begin {
// CHECK-NEXT:      simulation.scheduler_create @[[scheduler_0]]
// CHECK-NEXT:      simulation.scheduler_add_equation @[[scheduler_0]] {function = @[[equation_0_wrapper:.*]], ranges = #[[range]]}
// CHECK-NEXT:  }

// CHECK:       simulation.equation_function @[[equation_0_wrapper]](%[[i0_lb:.*]]: index, %[[i0_ub:.*]]: index) {
// CHECK-NEXT:      modelica.call @equation_0(%[[i0_lb]], %[[i0_ub]])
// CHECK-NEXT:      simulation.return
// CHECK-NEXT:  }

// CHECK:       simulation.dynamic_model_end {
// CHECK-NEXT:      simulation.scheduler_destroy @[[scheduler_0]]
// CHECK-NEXT:  }

// CHECK:       simulation.scheduler @[[scheduler_1]]

// CHECK:       simulation.dynamic_model_begin {
// CHECK-NEXT:      simulation.scheduler_create @[[scheduler_1]]
// CHECK-NEXT:      simulation.scheduler_add_equation @[[scheduler_1]] {function = @[[equation_1_wrapper:.*]], ranges = #[[range]]}
// CHECK-NEXT:  }

// CHECK:       simulation.equation_function @[[equation_1_wrapper]](%[[i0_lb:.*]]: index, %[[i0_ub:.*]]: index) {
// CHECK-NEXT:      modelica.call @equation_1(%[[i0_lb]], %[[i0_ub]])
// CHECK-NEXT:      simulation.return
// CHECK-NEXT:  }

// CHECK:       simulation.dynamic_model_end {
// CHECK-NEXT:      simulation.scheduler_destroy @[[scheduler_1]]
// CHECK-NEXT:  }
