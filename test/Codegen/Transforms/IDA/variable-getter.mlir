...
// CHECK:           %[[get:.*]] = modelica.qualified_variable_get @Test::@x : !modelica.real
...
// CHECK:           %[[get:.*]] = modelica.qualified_variable_get @Test::@der_x : !modelica.real
// CHECK:           %[[cast:.*]] = modelica.cast %[[get]] : !modelica.real -> f64
// CHECK:           sundials.return %[[cast]]
// CHECK-NEXT:  }
...
// CHECK:           %[[get:.*]] = modelica.qualified_variable_get @Test::@x : !modelica.array<2x!modelica.real>
...
// CHECK:           %[[get:.*]] = modelica.qualified_variable_get @Test::@der_x : !modelica.array<2x!modelica.real>
// CHECK:           %[[load:.*]] = modelica.load %[[get]][%[[index]]]
// CHECK:           %[[cast:.*]] = modelica.cast %[[load]] : !modelica.real -> f64
// CHECK:           sundials.return %[[cast]]
// CHECK-NEXT:  }
...
// CHECK:           %[[get:.*]] = modelica.qualified_variable_get @Test::@x : !modelica.array<2x3x!modelica.real>
...
// CHECK:           %[[get:.*]] = modelica.qualified_variable_get @Test::@der_x : !modelica.array<2x3x!modelica.real>
// CHECK:           %[[load:.*]] = modelica.load %[[get]][%[[index_0]], %[[index_1]]]
// CHECK:           %[[cast:.*]] = modelica.cast %[[load]] : !modelica.real -> f64
// CHECK:           sundials.return %[[cast]]
// CHECK-NEXT:  }
