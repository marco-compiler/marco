...
bmodelica.model @Test {
    ...
    %t1 = bmodelica.equation_template inductions = [%i0] attributes {id = "t1"} {
        %0 = bmodelica.variable_get @y : !bmodelica.array<4x!bmodelica.real>
        %1 = bmodelica.variable_get @x : !bmodelica.array<5x!bmodelica.real>
        %2 = bmodelica.load %0[%i0] : !bmodelica.array<4x!bmodelica.real>
        %3 = bmodelica.constant 1 : index
        %4 = bmodelica.add %i0, %3 : (index, index) -> index
        %5 = bmodelica.load %1[%4] : !bmodelica.array<5x!bmodelica.real>
    ...
    %t2 = bmodelica.equation_template inductions = [%i0] attributes {id = "t2"} {
        %0 = bmodelica.variable_get @z : !bmodelica.array<5x!bmodelica.real>
        %1 = bmodelica.variable_get @x : !bmodelica.array<5x!bmodelica.real>
        %2 = bmodelica.variable_get @y : !bmodelica.array<4x!bmodelica.real>
        %3 = bmodelica.load %0[%i0] : !bmodelica.array<5x!bmodelica.real>
        %4 = bmodelica.load %1[%i0] : !bmodelica.array<5x!bmodelica.real>
        %5 = bmodelica.load %2[%i0] : !bmodelica.array<4x!bmodelica.real>
    ...
    %t3 = bmodelica.equation_template inductions = [] attributes {id = "t3"} {
        ...
        %3 = bmodelica.load %0[%2] : !bmodelica.array<5x!bmodelica.real>
        %4 = bmodelica.load %1[%2] : !bmodelica.array<5x!bmodelica.real>
    ...
    bmodelica.dynamic {
        ...
        bmodelica.equation_instance %t1 {indices = #modeling<multidim_range [0,3]>} : !bmodelica.equation
        bmodelica.equation_instance %t2 {indices = #modeling<multidim_range [0,3]>} : !bmodelica.equation
