...
modelica.model @Test {
    ...
    modelica.main_model {
        // CHECK-DAG: modelica.matched_equation_instance %[[t0]] {indices = #modeling<multidim_range [0,2]>, path = #modelica<equation_path [L, 0, 0]>}
        // CHECK-DAG: modelica.matched_equation_instance %[[t1]] {indices = #modeling<multidim_range [3,6]>, path = #modelica<equation_path [L, 0, 0]>}
        // CHECK-DAG: modelica.matched_equation_instance %[[t2]] {indices = #modeling<multidim_range [7,8]>, path = #modelica<equation_path [L, 0, 0]>}
        // CHECK-DAG: modelica.matched_equation_instance %[[t3]] {indices = #modeling<multidim_range [0,2]>, path = #modelica<equation_path [L, 0]>}
