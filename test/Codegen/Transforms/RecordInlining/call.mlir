...
bmodelica.function @Foo {
    ...
    bmodelica.algorithm {
        ...
        %2 = bmodelica.variable_get @y : !bmodelica.real
        bmodelica.component_set %0, @x, %1 : !bmodelica<record @R>, !bmodelica.real
        bmodelica.component_set %0, @y, %2 : !bmodelica<record @R>, !bmodelica.real
    }
}
