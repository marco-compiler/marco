...
// CHECK-NEXT:      %[[subscription0:.*]] = modelica.subscription %[[array]][%[[index0]]] : !modelica.array<3x!modelica.real>
...
// CHECK-NEXT:      %[[subscription1:.*]] = modelica.subscription %[[array]][%[[index1]]] : !modelica.array<3x!modelica.real>
...
// CHECK-NEXT:      %[[subscription2:.*]] = modelica.subscription %[[array]][%[[index2]]] : !modelica.array<3x!modelica.real>
