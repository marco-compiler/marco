...
// CHECK-NEXT:      bmodelica.variable.set @y, %[[if_value]]
// CHECK-NEXT:  } else {
...
// CHECK-NEXT:          bmodelica.variable.set @y, %[[elseif_1_value]]
// CHECK-NEXT:      } else {
...
// CHECK-NEXT:              bmodelica.variable.set @y, %[[elseif_2_value]]
// CHECK-NEXT:          } else {
// CHECK-NEXT:              %[[else_value:.*]] = bmodelica.constant #bmodelica<int 4>
// CHECK-NEXT:              bmodelica.variable.set @y, %[[else_value]]
// CHECK-NEXT:          }
// CHECK-NEXT:      }
// CHECK-NEXT:  }
