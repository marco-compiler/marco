...
// CHECK:               %[[r:.*]] = bmodelica.variable.get @r : tensor<3x!bmodelica<record @R>>
// CHECK:               %[[view:.*]] = bmodelica.tensor.view %[[r]][%[[subscript]]] : tensor<3x!bmodelica<record @R>>, index -> tensor<!bmodelica<record @R>>
// CHECK:               %[[extract:.*]] = bmodelica.tensor.extract %[[view]][] : tensor<!bmodelica<record @R>>
