...
// CHECK-NEXT:      %[[x_value:.*]] = bmodelica.tensor.from_elements %[[x_value_1]], %[[x_value_2]], %[[x_value_3]]
...
// CHECK-NEXT:      %[[y_value:.*]] = bmodelica.tensor.from_elements %[[y_value_4]], %[[y_value_5]], %[[y_value_6]]
