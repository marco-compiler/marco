module attributes {dlti.dl_spec = #dlti.dl_spec<"dlti.endianness" = "little", "dlti.stack_alignment" = 128 : i64, "dlti.mangling_mode" = "e", !llvm.ptr = dense<64> : vector<4xi64>, !llvm.ptr<272> = dense<64> : vector<4xi64>, !llvm.ptr<271> = dense<32> : vector<4xi64>, !llvm.ptr<270> = dense<32> : vector<4xi64>, f64 = dense<64> : vector<2xi64>, f128 = dense<128> : vector<2xi64>, f16 = dense<16> : vector<2xi64>, f80 = dense<128> : vector<2xi64>, i16 = dense<16> : vector<2xi64>, i32 = dense<32> : vector<2xi64>, i8 = dense<8> : vector<2xi64>, i1 = dense<8> : vector<2xi64>, i128 = dense<128> : vector<2xi64>, i64 = dense<64> : vector<2xi64>, !bmodelica.real = ["size", 64], !bmodelica.int = ["size", 64]>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  ...
  bmodelica.function @externalLogReal {
    ...
    %2 = bmodelica.call @discreteLog(%0, %1) : (!bmodelica.int, !bmodelica.int) -> !bmodelica.real
    bmodelica.variable_set @ris, %2 : !bmodelica.real
  }
  bmodelica.model @SimpleFirstOrder  {
    ...
    bmodelica.dynamic {
      bmodelica.equation {
        ...
        %2 = bmodelica.constant #bmodelica<real 1.000000e+01> : !bmodelica.real
        %3 = bmodelica.constant #bmodelica<int 2> : !bmodelica.int
        %4 = bmodelica.constant #bmodelica<int 256> : !bmodelica.int
        %5 = bmodelica.call @externalLogReal(%3, %4) : (!bmodelica.int, !bmodelica.int) -> !bmodelica.real
        %6 = bmodelica.sub %2, %5 : (!bmodelica.real, !bmodelica.real) -> !bmodelica.real
