...
TEST(ScalarEquation, iterationRanges)
{
  ...
  auto equationOp = createEquation(builder, model, llvm::None, [&](mlir::OpBuilder& nested, mlir::ValueRange indices) {
    mlir::Value loadX = nested.create<LoadOp>(builder.getUnknownLoc(), model.equationsRegion().getArgument(0));
    mlir::Value loadY = nested.create<LoadOp>(builder.getUnknownLoc(), model.equationsRegion().getArgument(0));
...
TEST(ScalarEquation, accesses)
{
  ...
  auto equationOp = createEquation(builder, model, llvm::None, [&](mlir::OpBuilder& nested, mlir::ValueRange indices) {
    mlir::Value loadX = nested.create<LoadOp>(builder.getUnknownLoc(), model.equationsRegion().getArgument(0));
    mlir::Value loadY = nested.create<LoadOp>(builder.getUnknownLoc(), model.equationsRegion().getArgument(1));
    createEquationSides(nested, loadX, loadY);
  });
...
TEST(LoopEquation, explicitLoops_iterationRanges)
{
  ...
  auto equationOp = createEquation(builder, model, equationRanges, [&](mlir::OpBuilder& nested, mlir::ValueRange indices) {
    ...
    mlir::Value lhs = nested.create<LoadOp>(loc, model.equationsRegion().getArgument(0), xIndexes);
    mlir::Value rhs = nested.create<LoadOp>(loc, model.equationsRegion().getArgument(1), yIndexes);
...
TEST(LoopEquation, explicitLoops_accesses)
{
  ...
  auto equationOp = createEquation(builder, model, equationRanges, [&](mlir::OpBuilder& nested, mlir::ValueRange indices) {
    ...
    mlir::Value lhs = nested.create<LoadOp>(loc, model.equationsRegion().getArgument(0), xIndexes);
    mlir::Value rhs = nested.create<LoadOp>(loc, model.equationsRegion().getArgument(1), indices[0]);
...
TEST(LoopEquation, implicitLoops_iterationRanges)
{
  ...
  auto equationOp = createEquation(builder, model, llvm::None, [&](mlir::OpBuilder& nested, mlir::ValueRange indices) {
    mlir::Value lhs = model.equationsRegion().getArgument(0);
    mlir::Value rhs = model.equationsRegion().getArgument(1);
    createEquationSides(nested, lhs, rhs);
  });
