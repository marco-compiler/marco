...
{
  IndexSet::Impl::Impl(impl::IndexSetKind kind)
      : kind(kind)
  {
  }
...
namespace marco::modeling
{
  IndexSet::IndexSet(std::unique_ptr<Impl> impl)
      : impl(std::move(impl))
  {
  ...
  IndexSet::IndexSet()
      : impl(std::make_unique<impl::RTreeIndexSet>())
  {
  }
...
namespace marco::modeling
{
  IndexSet::PointIterator::Impl::Impl(impl::IndexSetKind kind)
      : kind(kind)
  {
  }
  ...
  IndexSet::PointIterator::Impl::Impl(
      IndexSet::PointIterator::Impl&& other) = default;
...
namespace marco::modeling
{
  ...
  IndexSet::PointIterator::value_type
  IndexSet::PointIterator::operator*() const
  {
    return **impl;
  }
}
...
namespace marco::modeling
{
  IndexSet::RangeIterator::Impl::Impl(impl::IndexSetKind kind)
      : kind(kind)
  {
  }
  ...
  IndexSet::RangeIterator::Impl::Impl(
      IndexSet::RangeIterator::Impl&& other) = default;
...
namespace marco::modeling
{
  ...
  IndexSet::RangeIterator::RangeIterator(
      IndexSet::RangeIterator&& other) = default;

  IndexSet::RangeIterator::~RangeIterator() = default;

  IndexSet::RangeIterator& IndexSet::RangeIterator::operator=(
      const IndexSet::RangeIterator& other)
  {
