...
DimensionAccessSub::DimensionAccessSub(mlir::MLIRContext *context,
...
DimensionAccessSub::DimensionAccessSub(DimensionAccessSub &&other) noexcept =
    default;
...
DimensionAccessSub &
DimensionAccessSub::operator=(DimensionAccessSub &&other) noexcept = default;
...
llvm::raw_ostream &
DimensionAccessSub::dump(llvm::raw_ostream &os,
...
void DimensionAccessSub::collectIterationSpaces(
...
IndexSet DimensionAccessSub::map(
    const Point &point,
