...
namespace modelica
{
	...
	class CallOp : public mlir::Op<CallOp, mlir::OpTrait::ZeroRegion, mlir::OpTrait::VariadicResults, mlir::OpTrait::VariadicOperands, mlir::MemoryEffectOpInterface::Trait, mlir::CallOpInterface::Trait>
	{
		...
		static llvm::StringRef getOperationName();
		static void build(mlir::OpBuilder& builder, mlir::OperationState& state, mlir::StringRef callee, mlir::TypeRange results, mlir::ValueRange args, unsigned int elementWiseRank = 0, unsigned int movedResults = 0);
		void print(mlir::OpAsmPrinter& printer);
