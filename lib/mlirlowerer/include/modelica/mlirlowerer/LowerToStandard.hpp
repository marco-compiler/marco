...
namespace modelica
{
	 ...
	 */
	void populateModelicaToStandardConversionPatterns(mlir::OwningRewritePatternList& patterns, mlir::MLIRContext* context);
	 ...
	 * @return pass
	 */
	std::unique_ptr<mlir::Pass> createModelicaToStandardLoweringPass();
}
