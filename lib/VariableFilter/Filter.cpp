...
Filter Filter::visibleArray(llvm::ArrayRef<long> shape) {
  ...
  for (const auto &dimension : shape) {
    long start = 0;
    long end =
        dimension == Range::kUnbounded ? Range::kUnbounded : dimension - 1;
...
bool Filter::isVisible() const { return visibility; }

llvm::ArrayRef<Range> Filter::getRanges() const { return ranges; }
} // namespace marco::vf
