...
Member::Member(SourceRange location)
    : ASTNode(ASTNodeKind::Member, std::move(location)), name(""),
      isPublicMember(true) {}
...
llvm::StringRef Member::getName() const { return name; }

void Member::setName(llvm::StringRef newName) { name = newName.str(); }
...
TypePrefix *Member::getTypePrefix() { return typePrefix->cast<TypePrefix>(); }
...
void Member::setPublic(bool value) { isPublicMember = value; }

bool Member::isDiscrete() const { return getTypePrefix()->isDiscrete(); }

bool Member::isParameter() const { return getTypePrefix()->isParameter(); }

bool Member::isConstant() const { return getTypePrefix()->isConstant(); }

bool Member::isInput() const { return getTypePrefix()->isInput(); }

bool Member::isOutput() const { return getTypePrefix()->isOutput(); }

bool Member::hasModification() const { return modification != nullptr; }
