...
void ExternalFunctionCallLowerer::getRecordConstructorInputVariables(
    llvm::SmallVectorImpl<mlir::bmodelica::VariableOp> &inputVariables,
...
bool ExternalFunctionCallLowerer::lowerRecordConstructorArgs(
    const ast::Call &call,
...
bool ExternalFunctionCallLowerer::lowerBuiltInFunctionArgs(
...
std::optional<mlir::Value>
ExternalFunctionCallLowerer::lowerBuiltInFunctionArg(const ast::FunctionArgument &arg) {
...
bool ExternalFunctionCallLowerer::getVectorizedResultTypes(
...
bool ExternalFunctionCallLowerer::isBuiltInFunction(
...
ExternalFunctionCallLowerer::dispatchBuiltInFunctionCall(const ast::Call &call) {
...
void ExternalFunctionCallLowerer::emitErrorNumArgumentsRange(llvm::StringRef function,
                                             const marco::SourceRange &location,
                                             unsigned int actualNum,
...
std::optional<Results> ExternalFunctionCallLowerer::abs(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::acos(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::asin(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "asin");
...
std::optional<Results> ExternalFunctionCallLowerer::atan(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "atan");
...
std::optional<Results> ExternalFunctionCallLowerer::atan2(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "atan2");
...
std::optional<Results> ExternalFunctionCallLowerer::cos(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::cosh(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "cosh");
...
std::optional<Results> ExternalFunctionCallLowerer::der(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::diagonal(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "diagonal");
...
std::optional<Results> ExternalFunctionCallLowerer::div(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::exp(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::fill(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "fill");
...
std::optional<Results> ExternalFunctionCallLowerer::floor(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "floor");
...
std::optional<Results> ExternalFunctionCallLowerer::identity(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "identity");
...
std::optional<Results> ExternalFunctionCallLowerer::integer(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "integer");
...
std::optional<Results> ExternalFunctionCallLowerer::linspace(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "linspace");
...
std::optional<Results> ExternalFunctionCallLowerer::log(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::log10(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "log10");
...
std::optional<Results> ExternalFunctionCallLowerer::max(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::maxArray(const ast::Call &call) {
  assert(call.getNumOfArguments() == 1);
...
std::optional<Results> ExternalFunctionCallLowerer::maxReduction(const ast::Call &call) {
  return reduction(call, "max");
}

std::optional<Results> ExternalFunctionCallLowerer::maxScalars(const ast::Call &call) {
  constexpr unsigned int expectedNumArgs = 2;
  if (call.getNumOfArguments() != expectedNumArgs) {
...
std::optional<Results> ExternalFunctionCallLowerer::min(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::minArray(const ast::Call &call) {
  assert(call.getNumOfArguments() == 1);
...
std::optional<Results> ExternalFunctionCallLowerer::minReduction(const ast::Call &call) {
  return reduction(call, "min");
}

std::optional<Results> ExternalFunctionCallLowerer::minScalars(const ast::Call &call) {
  constexpr unsigned int expectedNumArgs = 2;
  if (call.getNumOfArguments() != expectedNumArgs) {
...
std::optional<Results> ExternalFunctionCallLowerer::mod(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::ndims(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "ndims");
...
std::optional<Results> ExternalFunctionCallLowerer::ones(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "ones");
...
std::optional<Results> ExternalFunctionCallLowerer::product(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "product");
...
std::optional<Results> ExternalFunctionCallLowerer::productArray(const ast::Call &call) {
  constexpr unsigned int expectedNumArgs = 1;
  if (call.getNumOfArguments() != expectedNumArgs) {
    emitErrorNumArguments("product", call.getLocation(),
                          call.getNumOfArguments(), expectedNumArgs);
...
std::optional<Results> ExternalFunctionCallLowerer::productReduction(const ast::Call &call) {
  return reduction(call, "mul");
}

std::optional<Results> ExternalFunctionCallLowerer::rem(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::sign(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "sign");
...
std::optional<Results> ExternalFunctionCallLowerer::sin(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::sinh(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "sinh");
...
std::optional<Results> ExternalFunctionCallLowerer::size(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "size");
...
std::optional<Results> ExternalFunctionCallLowerer::sqrt(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "sqrt");
...
std::optional<Results> ExternalFunctionCallLowerer::sum(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::sumArray(const ast::Call &call) {
  constexpr unsigned int expectedNumArgs = 1;
  if (call.getNumOfArguments() != expectedNumArgs) {
    emitErrorNumArguments("sum", call.getLocation(), call.getNumOfArguments(),
                          expectedNumArgs);
...
std::optional<Results> ExternalFunctionCallLowerer::sumReduction(const ast::Call &call) {
  return reduction(call, "add");
}

std::optional<Results> ExternalFunctionCallLowerer::symmetric(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "symmetric");
...
std::optional<Results> ExternalFunctionCallLowerer::tan(const ast::Call &call) {
...
std::optional<Results> ExternalFunctionCallLowerer::tanh(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "tanh");
...
std::optional<Results> ExternalFunctionCallLowerer::transpose(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "transpose");
...
std::optional<Results> ExternalFunctionCallLowerer::zeros(const ast::Call &call) {
  assert(call.getCallee()->cast<ast::ComponentReference>()->getName() ==
         "zeros");
...
std::optional<Results> ExternalFunctionCallLowerer::reduction(const ast::Call &call,
