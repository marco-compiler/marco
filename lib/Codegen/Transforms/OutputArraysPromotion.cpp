...
class OutputArraysPromotionPass: public mlir::PassWrapper<OutputArraysPromotionPass, mlir::OperationPass<mlir::ModuleOp>>
{
	public:
...
std::unique_ptr<mlir::Pass> marco::codegen::createOutputArraysPromotionPass()
{
	return std::make_unique<OutputArraysPromotionPass>();
}
