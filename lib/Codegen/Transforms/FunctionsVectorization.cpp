    ...
    public:
      ...
      void runOnOperation() override
      {
        ...
        for (auto& op : vectorizedOps) {
          if (auto result = scalarize(builder, op.first, op.second); mlir::failed(result)) {
...
{
  std::unique_ptr<mlir::Pass> createFunctionsVectorizationPass(FunctionsVectorizationOptions options)
  {
