...
LoweringBridge::LoweringBridge(mlir::MLIRContext& context, CodegenOptions options)
		: builder(&context),
			options(options)
{
...
mlir::Location LoweringBridge::loc(SourcePosition location)
{
...
mlir::Location LoweringBridge::loc(SourceRange location)
{
	return loc(location.getStartPosition());
}

llvm::Optional<mlir::ModuleOp> LoweringBridge::run(llvm::ArrayRef<std::unique_ptr<Class>> classes)
{
...
mlir::Operation* LoweringBridge::lower(const ast::Class& cls)
{
...
mlir::Operation* LoweringBridge::lower(const ast::PartialDerFunction& function)
{
...
mlir::Operation* LoweringBridge::lower(const ast::StandardFunction& function)
{
	mlir::OpBuilder::InsertionGuard guard(builder);
...
mlir::Operation* LoweringBridge::lower(const ast::Model& model)
{
	mlir::OpBuilder::InsertionGuard guard(builder);
	llvm::ScopedHashTableScope<mlir::StringRef, Reference> varScope(symbolTable);
...
mlir::Operation* LoweringBridge::lower(const ast::Package& package)
{
	mlir::ModuleOp module = mlir::ModuleOp::create(builder.getUnknownLoc());
...
mlir::Operation* LoweringBridge::lower(const ast::Record& record)
{
	/*
	llvm::ScopedHashTableScope<mlir::StringRef, Reference> varScope(symbolTable);
...
mlir::Type LoweringBridge::lower(const Type& type, BufferAllocationScope desiredAllocationScope)
{
...
mlir::Type LoweringBridge::lower(const BuiltInType& type, BufferAllocationScope desiredAllocationScope)
{
	switch (type)
	{
...
mlir::Type LoweringBridge::lower(const PackedType& type, BufferAllocationScope desiredAllocationScope)
{
...
mlir::Type LoweringBridge::lower(const UserDefinedType& type, BufferAllocationScope desiredAllocationScope)
{
	llvm::SmallVector<mlir::Type, 3> types;
...
template<>
void LoweringBridge::lower<ast::Model>(const Member& member)
{
 ...
 */
template<>
void LoweringBridge::lower<Function>(const Member& member)
{
	auto location = loc(member.getLocation());
...
void LoweringBridge::lower(const Equation& equation)
{
...
void LoweringBridge::lower(const ForEquation& forEquation)
{
	llvm::ScopedHashTableScope<mlir::StringRef, Reference> varScope(symbolTable);
...
void LoweringBridge::lower(const Algorithm& algorithm)
{
	for (const auto& statement : algorithm)
		lower(*statement);
}

void LoweringBridge::lower(const Statement& statement)
{
	statement.visit([&](const auto& obj) { lower(obj); });
}

void LoweringBridge::lower(const AssignmentStatement& statement)
{
...
void LoweringBridge::lower(const IfStatement& statement)
{
...
void LoweringBridge::lower(const ForStatement& statement)
{
	llvm::ScopedHashTableScope<mlir::StringRef, Reference> varScope(symbolTable);
	auto location = loc(statement.getLocation());
...
void LoweringBridge::lower(const WhileStatement& statement)
{
	llvm::ScopedHashTableScope<mlir::StringRef, Reference> varScope(symbolTable);
	auto location = loc(statement.getLocation());
...
void LoweringBridge::lower(const WhenStatement& statement)
{

}

void LoweringBridge::lower(const BreakStatement& statement)
{
	mlir::Location location = loc(statement.getLocation());
	builder.create<BreakOp>(location);
}

void LoweringBridge::lower(const ReturnStatement& statement)
{
	mlir::Location location = loc(statement.getLocation());
...
template<>
LoweringBridge::Container<Reference> LoweringBridge::lower<Expression>(const Expression& expression)
{
...
template<>
LoweringBridge::Container<Reference> LoweringBridge::lower<Operation>(const Expression& expression)
{
...
template<>
LoweringBridge::Container<Reference> LoweringBridge::lower<Constant>(const Expression& expression)
{
...
template<>
LoweringBridge::Container<Reference> LoweringBridge::lower<ReferenceAccess>(const Expression& expression)
{
...
template<>
LoweringBridge::Container<Reference> LoweringBridge::lower<Call>(const Expression& expression)
{
...
template<>
LoweringBridge::Container<Reference> LoweringBridge::lower<Tuple>(const Expression& expression)
{
...
template<>
LoweringBridge::Container<Reference> LoweringBridge::lower<Array>(const Expression& expression)
{
...
mlir::Value LoweringBridge::foldBinaryOperation(llvm::ArrayRef<mlir::Value> args, std::function<mlir::Value(mlir::Value, mlir::Value)> callback)
{
	assert(args.size() >= 2);
...
LoweringBridge::Container<mlir::Value> LoweringBridge::lowerOperationArgs(const Operation& operation)
{
