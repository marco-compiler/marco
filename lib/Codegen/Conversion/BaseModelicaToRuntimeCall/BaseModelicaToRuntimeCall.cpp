...
static mlir::runtime::FunctionOp getOrDeclareRuntimeFunction(
    ...
    mlir::TypeRange args)
{
  ...
  auto funcOp = builder.create<mlir::runtime::FunctionOp>(
    ...
    protected:
      ...
      [[nodiscard]] std::string getMangledType(mlir::Type type) const
      {
        ...
        if (auto tensorType = type.dyn_cast<mlir::UnrankedTensorType>()) {
          return getMangler()->getArrayType(getMangledType(tensorType.getElementType()));
        }
      ...
      [[nodiscard]] std::string getMangledFunctionName(
          llvm::StringRef name,
      ...
      mlir::runtime::FunctionOp getOrDeclareRuntimeFunction(
          mlir::OpBuilder& builder,
          mlir::ModuleOp moduleOp,
          llvm::StringRef name,
          mlir::TypeRange results,
      ...
      mlir::LogicalResult addCallArgument(
          mlir::OpBuilder& builder,
          mlir::Location loc,
          ...
          mlir::Value argument) const
      {
        ...
        if (auto tensorType = argType.dyn_cast<mlir::RankedTensorType>()) {
          ...
          if (!tensor.getType().isa<mlir::UnrankedTensorType>()) {
            ...
            tensor = builder.create<mlir::tensor::CastOp>(
                loc, unrankedTensorType, tensor);
          }
        ...
        if (auto memRefType = argType.dyn_cast<mlir::MemRefType>()) {
          ...
          if (!memRef.getType().isa<mlir::UnrankedMemRefType>()) {
            ...
            memRef = builder.create<mlir::memref::CastOp>(
      ...
      mlir::Value convertToUnrankedMemRef(
          mlir::OpBuilder& builder, mlir::Value memRef) const
      {
        ...
        return builder.create<mlir::memref::CastOp>(
            memRef.getLoc(), unrankedMemRefType, memRef);
      }

      mlir::Value convertToTensor(
          mlir::OpBuilder& builder, mlir::Value memRef) const
      {
        auto memRefType = memRef.getType().cast<mlir::MemRefType>();
...
namespace
{
  struct PowOpLowering: public RuntimeOpConversionPattern<PowOp>
  {
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      // Base.
      if (mlir::failed(addCallArgument(
              rewriter, loc, arguments, adaptor.getBase()))) {
        return mlir::failure();
      }

      // Exponent.
      if (mlir::failed(addCallArgument(
              rewriter, loc, arguments, adaptor.getExponent()))) {
        return mlir::failure();
      }
      ...
      auto callee = getOrDeclareRuntimeFunction(
          ...
          getMangledFunctionName("pow", resultType, arguments),
...
namespace
{
  struct AbsOpLowering: public RuntimeOpConversionPattern<AbsOp>
  {
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      auto callOp = rewriter.create<mlir::runtime::CallOp>(
          loc, callee, arguments);
  ...
  struct DiagonalOpLowering: public RuntimeOpConversionPattern<DiagonalOp>
  {
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      if (requestedResultTensorType.getElementType() !=
        ...
        values = rewriter.create<CastOp>(
            loc, compatibleValuesTensorType, values);
      }
      ...
      rewriter.create<mlir::runtime::CallOp>(
          loc, callee, arguments);

      result = rewriter.create<mlir::memref::CastOp>(
          loc, resultMemRefType, result);
        ...
        if (dimensionSize == mlir::ShapedType::kDynamic) {
          if (dynamicDimensions.empty()) {
            ...
            if (!indexSize.getType().isa<mlir::IndexType>()) {
              indexSize = rewriter.create<CastOp>(
                  loc, rewriter.getIndexType(), indexSize);
            }
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      if (requestedResultTensorType.getDimSize(0) ==
        ...
        if (!amount.getType().isa<mlir::IndexType>()) {
          amount = rewriter.create<CastOp>(
              loc, rewriter.getIndexType(), amount);
        }
      ...
      if (mlir::failed(addCallArgument(
              rewriter, loc, arguments, begin))) {
        return mlir::failure();
      }

      if (mlir::failed(addCallArgument(
              rewriter, loc, arguments, end))) {
        return mlir::failure();
      }
  ...
  struct MaxOpScalarsLowering: public RuntimeOpConversionPattern<MaxOp>
  {
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      if (!first.getType().isa<
              mlir::IndexType, mlir::IntegerType, mlir::FloatType>()) {
        return rewriter.notifyMatchFailure(op, "Incompatible operands");
      }

      if (!second.getType().isa<
              mlir::IndexType, mlir::IntegerType, mlir::FloatType>()) {
        return rewriter.notifyMatchFailure(op, "Incompatible operands");
      }
  ...
  struct MaxOpArrayLowering: public RuntimeOpConversionPattern<MaxOp>
  {
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      auto callee = getOrDeclareRuntimeFunction(
          rewriter,
          op->getParentOfType<mlir::ModuleOp>(),
          getMangledFunctionName("maxArray", elementType, arguments),
  ...
  struct MinOpArrayLowering: public RuntimeOpConversionPattern<MinOp>
  {
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      auto callee = getOrDeclareRuntimeFunction(
          rewriter,
          op->getParentOfType<mlir::ModuleOp>(),
          getMangledFunctionName("minArray", elementType, arguments),
          elementType, arguments);
  ...
  struct OnesOpLowering: public RuntimeOpConversionPattern<OnesOp>
  {
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      auto callee = getOrDeclareRuntimeFunction(
          rewriter,
          op->getParentOfType<mlir::ModuleOp>(),
          getMangledFunctionName("ones", std::nullopt, arguments),
          std::nullopt, arguments);
  ...
  struct ProductOpLowering: public RuntimeOpConversionPattern<ProductOp>
  {
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      auto callee = getOrDeclareRuntimeFunction(
          rewriter,
          op->getParentOfType<mlir::ModuleOp>(),
          getMangledFunctionName("product", elementType, arguments),
          elementType, arguments);
  ...
  struct SumOpLowering: public RuntimeOpConversionPattern<SumOp>
  {
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      auto callee = getOrDeclareRuntimeFunction(
          rewriter,
          op->getParentOfType<mlir::ModuleOp>(),
          getMangledFunctionName("sum", elementType, arguments),
          elementType, arguments);
  ...
  struct SymmetricOpLowering: public RuntimeOpConversionPattern<SymmetricOp>
  {
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      if (requestedResultTensorType.getDimSize(1) ==
          mlir::ShapedType::kDynamic) {
  ...
  struct ZerosOpLowering: public RuntimeOpConversionPattern<ZerosOp>
  {
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      auto callee = getOrDeclareRuntimeFunction(
          rewriter,
          op->getParentOfType<mlir::ModuleOp>(),
          getMangledFunctionName("zeros", std::nullopt, arguments),
          std::nullopt, arguments);
  ...
  struct PrintOpLowering: public RuntimeOpConversionPattern<PrintOp>
  {
        ...
        mlir::ConversionPatternRewriter& rewriter) const override
    {
      ...
      auto callee = getOrDeclareRuntimeFunction(
          rewriter,
          op->getParentOfType<mlir::ModuleOp>(),
          getMangledFunctionName("print", std::nullopt, arguments),
          std::nullopt, arguments);
