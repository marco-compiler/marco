...
namespace
{
  class ModelNameOpLowering : public SimulationOpRewritePattern<ModelNameOp>
  {
    public:
      using SimulationOpRewritePattern<ModelNameOp>
  ...
  class NumberOfVariablesOpLowering
      : public SimulationOpRewritePattern<NumberOfVariablesOp>
  {
    public:
      using SimulationOpRewritePattern<NumberOfVariablesOp>
          ::SimulationOpRewritePattern;
  ...
  class VariableNamesOpLowering
      : public SimulationOpRewritePattern<VariableNamesOp>
  {
    public:
      using SimulationOpRewritePattern<VariableNamesOp>
          ::SimulationOpRewritePattern;
  ...
  class VariableRanksOpLowering
      : public SimulationOpRewritePattern<VariableRanksOp>
  {
    public:
      using SimulationOpRewritePattern<VariableRanksOp>
          ::SimulationOpRewritePattern;
  ...
  class PrintableIndicesOpLowering
      : public SimulationOpRewritePattern<PrintableIndicesOp>
  {
    public:
      using SimulationOpRewritePattern<PrintableIndicesOp>
          ::SimulationOpRewritePattern;
  ...
  class DerivativesMapOpLowering
      : public SimulationOpRewritePattern<DerivativesMapOp>
  {
    public:
      using SimulationOpRewritePattern<DerivativesMapOp>
          ::SimulationOpRewritePattern;
  ...
  class VariableGetterOpLowering
      : public SimulationOpRewritePattern<VariableGetterOp>
  {
    public:
      using SimulationOpRewritePattern<VariableGetterOp>
          ::SimulationOpRewritePattern;
  ...
  class VariableGettersOpLowering
      : public SimulationOpRewritePattern<VariableGettersOp>
  {
    public:
      using SimulationOpRewritePattern<VariableGettersOp>
          ::SimulationOpRewritePattern;
  ...
  {
    public:
      using SimulationOpRewritePattern<FunctionOp>
          ::SimulationOpRewritePattern;
