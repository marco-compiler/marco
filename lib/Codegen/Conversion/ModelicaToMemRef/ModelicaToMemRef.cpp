...
namespace
{
  class ModelicaToMemRefConversionPass
      : public mlir::impl::ModelicaToMemRefConversionPassBase<
          ModelicaToMemRefConversionPass>
  {
    public:
      using ModelicaToMemRefConversionPassBase
        ::ModelicaToMemRefConversionPassBase;
