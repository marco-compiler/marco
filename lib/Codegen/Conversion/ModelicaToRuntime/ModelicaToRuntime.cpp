...
namespace mlir
{
#define GEN_PASS_DEF_MODELICATORUNTIMECONVERSIONPASS
...
namespace
{
  class ModelicaToRuntimeConversionPass
      : public mlir::impl::ModelicaToRuntimeConversionPassBase<
            ModelicaToRuntimeConversionPass>
  {
    public:
      using ModelicaToRuntimeConversionPassBase<
          ModelicaToRuntimeConversionPass>
          ::ModelicaToRuntimeConversionPassBase;
...
void ModelicaToRuntimeConversionPass::runOnOperation()
{
...
DerivativesMap& ModelicaToRuntimeConversionPass::getDerivativesMap(
    ModelOp modelOp)
{
...
mlir::LogicalResult
ModelicaToRuntimeConversionPass::addMissingRuntimeFunctions(
    mlir::OpBuilder& builder,
    mlir::ModuleOp moduleOp)
{
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::processModelOp(
    mlir::RewriterBase& rewriter,
    mlir::SymbolTableCollection& symbolTableCollection,
    mlir::ModuleOp moduleOp,
    ModelOp modelOp)
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::convertSchedules(
    mlir::RewriterBase& rewriter,
    mlir::SymbolTableCollection& symbolTableCollection,
    mlir::ModuleOp moduleOp,
    ModelOp modelOp)
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::convertScheduleBodyOp(
    mlir::RewriterBase& rewriter,
    mlir::IRMapping& mapping,
    InitialModelOp op)
{
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::createModelNameOp(
    mlir::OpBuilder& builder,
    mlir::ModuleOp moduleOp,
    ModelOp modelOp)
{
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::createNumOfVariablesOp(
    mlir::OpBuilder& builder,
    mlir::ModuleOp moduleOp,
    ModelOp modelOp,
    llvm::ArrayRef<VariableOp> variables)
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::createVariableNamesOp(
    mlir::OpBuilder& builder,
    mlir::ModuleOp moduleOp,
    ModelOp modelOp,
    llvm::ArrayRef<VariableOp> variables)
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::createVariableRanksOp(
    mlir::OpBuilder& builder,
    mlir::ModuleOp moduleOp,
    ModelOp modelOp,
    llvm::ArrayRef<VariableOp> variables)
...
mlir::LogicalResult
ModelicaToRuntimeConversionPass::createPrintableIndicesOp(
    mlir::OpBuilder& builder,
    mlir::ModuleOp moduleOp,
    ModelOp modelOp,
    llvm::ArrayRef<VariableOp> variables,
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::createDerivativesMapOp(
    mlir::OpBuilder& builder,
    mlir::ModuleOp moduleOp,
    ModelOp modelOp,
    llvm::ArrayRef<VariableOp> variables)
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::createVariableGetters(
    mlir::OpBuilder& builder,
    mlir::ModuleOp moduleOp,
    ModelOp modelOp,
    llvm::ArrayRef<VariableOp> variables)
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::createInitFunction(
    mlir::RewriterBase& rewriter,
    mlir::SymbolTableCollection& symbolTableCollection,
    mlir::ModuleOp moduleOp,
    ModelOp modelOp,
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::createDeinitFunction(
    mlir::OpBuilder& builder,
    mlir::ModuleOp moduleOp,
    ModelOp modelOp)
{
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::declareGlobalVariables(
    mlir::OpBuilder& builder,
    mlir::SymbolTableCollection& symbolTableCollection,
    mlir::ModuleOp moduleOp,
    llvm::ArrayRef<VariableOp> variables,
...
mlir::LogicalResult
ModelicaToRuntimeConversionPass::convertQualifiedVariableAccesses(
    mlir::SymbolTableCollection& symbolTableCollection,
    mlir::ModuleOp moduleOp,
    ModelOp modelOp,
    llvm::StringMap<GlobalVariableOp>& globalVariablesMap)
...
GlobalVariableOp ModelicaToRuntimeConversionPass::declareTimeVariable(
    mlir::OpBuilder& builder,
    mlir::ModuleOp moduleOp,
    mlir::SymbolTableCollection& symbolTableCollection)
{
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::createTimeGetterOp(
    mlir::OpBuilder& builder,
    mlir::ModuleOp moduleOp,
    mlir::SymbolTableCollection& symbolTableCollection,
    GlobalVariableOp timeVariableOp)
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::createTimeSetterOp(
    mlir::OpBuilder& builder,
    mlir::ModuleOp moduleOp,
    mlir::SymbolTableCollection& symbolTableCollection,
    GlobalVariableOp timeVariableOp)
...
mlir::LogicalResult ModelicaToRuntimeConversionPass::convertTimeOp(
    mlir::ModuleOp moduleOp)
{
...
namespace mlir
{
  ...
  {
    return std::make_unique<ModelicaToRuntimeConversionPass>();
  }

  std::unique_ptr<mlir::Pass> createModelicaToRuntimeConversionPass(
      const ModelicaToRuntimeConversionPassOptions& options)
  {
    return std::make_unique<ModelicaToRuntimeConversionPass>(options);
  }
}
