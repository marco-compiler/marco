...
namespace mlir
{
#define GEN_PASS_DEF_SIMULATIONTOLLVMCONVERSIONPASS
...
namespace
{
  class SimulationToLLVMConversionPass
      : public mlir::impl::SimulationToLLVMConversionPassBase<
            SimulationToLLVMConversionPass>
  {
    public:
      using SimulationToLLVMConversionPassBase<SimulationToLLVMConversionPass>
          ::SimulationToLLVMConversionPassBase;
...
void SimulationToLLVMConversionPass::runOnOperation()
{
...
namespace
{
  ...
  class SimulationOpConversion : public mlir::ConvertOpToLLVMPattern<Op>
  {
    public:
      SimulationOpConversion(
  ...
  class SchedulerOpLowering : public SimulationOpConversion<SchedulerOp>
  {
    public:
      using SimulationOpConversion<SchedulerOp>::SimulationOpConversion;
  ...
  struct SchedulerCreateOpLowering
      : public SimulationOpConversion<SchedulerCreateOp>
  {
    using SimulationOpConversion<SchedulerCreateOp>::SimulationOpConversion;
  ...
  struct SchedulerDestroyOpLowering
      : public SimulationOpConversion<SchedulerDestroyOp>
  {
    using SimulationOpConversion<SchedulerDestroyOp>::SimulationOpConversion;
  ...
  struct SchedulerAddEquationOpLowering
      : public SimulationOpConversion<SchedulerAddEquationOp>
  {
    using SimulationOpConversion<SchedulerAddEquationOp>
        ::SimulationOpConversion;
  ...
  struct SchedulerRunOpLowering : public SimulationOpConversion<SchedulerRunOp>
  {
    using SimulationOpConversion<SchedulerRunOp>::SimulationOpConversion;
...
mlir::LogicalResult SimulationToLLVMConversionPass::convertOps()
{
  mlir::ModuleOp moduleOp = getOperation();
  mlir::ConversionTarget target(getContext());

  target.addIllegalDialect<mlir::simulation::SimulationDialect>();
...
namespace mlir
{
  ...
  {
    return std::make_unique<SimulationToLLVMConversionPass>();
  }

  std::unique_ptr<mlir::Pass> createSimulationToLLVMConversionPass(
      const SimulationToLLVMConversionPassOptions& options)
  {
    return std::make_unique<SimulationToLLVMConversionPass>(options);
  }
}
