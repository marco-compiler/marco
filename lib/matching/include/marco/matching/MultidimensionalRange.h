#ifndef MARCO_MATCHING_MULTIDIMENSIONALRANGE_H
#define MARCO_MATCHING_MULTIDIMENSIONALRANGE_H
...
namespace marco::matching
{
  ...
  class MultidimensionalRange
  {
    ...
    using const_iterator = detail::MultidimensionalRangeIterator<data_type>;
...
#endif // MARCO_MATCHING_MULTIDIMENSIONALRANGE_H
