...
VariablesDependencyGraph::Node::Node() : graph(nullptr), variable(nullptr) {}

VariablesDependencyGraph::Node::Node(const VariablesDependencyGraph *graph,
...
size_t VariablesDependencyGraph::getNumOfNodes() const { return nodes.size(); }
