...
namespace mlir::bmodelica
{
  ...
  mlir::Attribute DenseBooleanElementsAttr::parse(
      mlir::AsmParser& parser, mlir::Type type)
  {
    ...
    if (!type) {
      ...
      type = mlir::RankedTensorType::get(
          shape, BooleanType::get(parser.getContext()));
    }
  ...
  mlir::Attribute DenseIntegerElementsAttr::parse(
      mlir::AsmParser& parser, mlir::Type type)
  {
    ...
    if (!type) {
      ...
      type = mlir::RankedTensorType::get(
          shape, IntegerType::get(parser.getContext()));
    }
  ...
  mlir::Attribute DenseRealElementsAttr::parse(
      mlir::AsmParser& parser, mlir::Type type)
  {
    ...
    if (!type) {
      ...
      type = mlir::RankedTensorType::get(
          shape, RealType::get(parser.getContext()));
    }
