...
struct BooleanTypeInterface
  ...
  mlir::Value materializeBoolConstant(mlir::Type type, mlir::OpBuilder &builder,
                                      mlir::Location loc, bool value) const {
    return builder.create<ConstantOp>(
        loc, BooleanAttr::get(builder.getContext(), value));
  }

  mlir::Value materializeIntConstant(mlir::Type type, mlir::OpBuilder &builder,
                                     mlir::Location loc, int64_t value) const {
    return materializeBoolConstant(type, builder, loc,
                                   static_cast<bool>(value != 0));
  }

  mlir::Value materializeFloatConstant(mlir::Type type,
                                       mlir::OpBuilder &builder,
                                       mlir::Location loc, double value) const {
    return materializeBoolConstant(type, builder, loc,
                                   static_cast<bool>(value != 0));
  }
};
...
struct IntegerTypeInterface
  ...
  mlir::Value materializeBoolConstant(mlir::Type type, mlir::OpBuilder &builder,
                                      mlir::Location loc, bool value) const {
    return materializeIntConstant(type, builder, loc,
...
struct RealTypeInterface
  ...
  mlir::Value materializeBoolConstant(mlir::Type type, mlir::OpBuilder &builder,
                                      mlir::Location loc, bool value) const {
    return materializeFloatConstant(type, builder, loc,
...
struct ConstantMaterializableBuiltinIndexModel
  ...
  static mlir::Value materializeBoolConstant(mlir::Type type,
                                             mlir::OpBuilder &builder,
                                             mlir::Location loc, bool value) {
    return builder.create<ConstantOp>(
        loc, builder.getIndexAttr(static_cast<int64_t>(value)));
  }

  static mlir::Value materializeIntConstant(mlir::Type type,
                                            mlir::OpBuilder &builder,
                                            mlir::Location loc, int64_t value) {
    return builder.create<ConstantOp>(loc, builder.getIndexAttr(value));
  }

  static mlir::Value materializeFloatConstant(mlir::Type type,
                                              mlir::OpBuilder &builder,
                                              mlir::Location loc,
                                              double value) {
    return builder.create<ConstantOp>(
...
struct ConstantMaterializableBuiltinFloatModel
  ...
  static mlir::Value materializeFloatConstant(mlir::Type type,
                                              ...
                                              mlir::Location loc,
                                              double value) {
    return builder.create<ConstantOp>(loc, builder.getFloatAttr(type, value));
  }
};
} // namespace
...
void registerConstantMaterializableTypeInterfaceExternalModels(
  ...
  registry.addExtension(+[](mlir::MLIRContext *context,
    ...
    mlir::IndexType::attachInterface<::ConstantMaterializableBuiltinIndexModel>(
        *context);
