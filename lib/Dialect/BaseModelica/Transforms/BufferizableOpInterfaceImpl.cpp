...
namespace
{
        ...
        const BufferizationOptions& options) const
    {
      ...
      mlir::FailureOr<mlir::BaseMemRefType> resultType =
          mlir::bufferization::getBufferType(
              rawVariableOp.getResult(), options);
  ...
  struct RawVariableGetOpInterface
      : public BufferizableOpInterface::ExternalModel<
            RawVariableGetOpInterface, RawVariableGetOp>
  {
    bool bufferizesToMemoryRead(
        mlir::Operation* op,
        mlir::OpOperand& opOperand,
        ...
        const BufferizationOptions& options) const
    {
      ...
      mlir::FailureOr<mlir::Value> memRef = getBuffer(
          rewriter, rawVariableGetOp.getVariable(), options);
      ...
      replaceOpWithNewBufferizedOp<RawVariableGetOp>(
          rewriter, op, rawVariableOp);
  ...
  struct RawVariableSetOpInterface
      : public BufferizableOpInterface::ExternalModel<
            RawVariableSetOpInterface, RawVariableSetOp>
  {
    bool bufferizesToAllocation(
        mlir::Operation* op,
        mlir::Value value) const
