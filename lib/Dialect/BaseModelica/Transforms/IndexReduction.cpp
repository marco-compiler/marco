...
mlir::LogicalResult IndexReductionPass::processModelOp(ModelOp modelOp) {
  ...
  // The result of the Pantelides algorithm is an over-determined system.
  // Apply the dummy derivatives algorithm to make the problem determined.
...
std::unique_ptr<State> IndexReductionPass::buildPantelidesGraph(
